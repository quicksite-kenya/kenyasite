...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function Qg(n,e,t){const i=new Float32Array(Ai),o=new Y(0,1,0);return new Fn({name:"SphericalGaussianBlur",defines:{n:Ai,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:kr(),fragmentShader:`
...
`)}const ic=new Qe;function tv(n){st._getMatrix(ic,st.workingColorSpace,n);const e=`mat3( ${ic.elements.map(t=>t.toFixed(4))} )`;switch(st.getTransfer(n)){case Mr:return[e,"LinearTransferOETF"];case gt:return[e,"sRGBTransferOETF"];default:return Je("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function oc(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const l=parseInt(s[1]);return t.toUpperCase()+`
...
`)}const iv={[rd]:"Linear",[sd]:"Reinhard",[ad]:"Cineon",[ld]:"ACESFilmic",[ud]:"AgX",[dd]:"Neutral",[cd]:"Custom"};function ov(n,e){const t=iv[e];return t===void 0?(Je("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ur=new Y;function rv(){st.getLuminanceCoefficients(ur);const n=ur.x.toFixed(4),e=ur.y.toFixed(4),t=ur.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class zy extends Zn{constructor(e){super(),this.apiClient=e,this.list=async(t={})=>new Ri(Kn.PAGED_ITEM_BATCH_JOBS,i=>this.listInternal(i),await this.listInternal(t),t),this.create=async t=>(this.apiClient.isVertexAI()&&(t.config=this.formatDestination(t.src,t.config)),this.createInternal(t)),this.createEmbeddings=async t=>{if(console.warn("batches.createEmbeddings() is experimental and may change without notice."),this.apiClient.isVertexAI())throw new Error("Vertex AI does not support batches.createEmbeddings.");return this.createEmbeddingsInternal(t)}}createInlinedGenerateContentRequest(e){const t=Uu(this.apiClient,e),i=t._url,o=Ee("{model}:batchGenerateContent",i),l=t.batch.inputConfig.requests,d=l.requests,c=[];for(const f of d){const p=Object.assign({},f);if(p.systemInstruction){const h=p.systemInstruction;delete p.systemInstruction;const m=p.request;m.systemInstruction=h,p.request=m}c.push(p)}return l.requests=c,delete t.config,delete t._url,delete t._query,{path:o,body:t}}getGcsUri(e){if(typeof e=="string")return e.startsWith("gs://")?e:void 0;if(!Array.isArray(e)&&e.gcsUri&&e.gcsUri.length>0)return e.gcsUri[0]}getBigqueryUri(e){if(typeof e=="string")return e.startsWith("bq://")?e:void 0;if(!Array.isArray(e))return e.bigqueryUri}formatDestination(e,t){const i=t?Object.assign({},t):{},o=Date.now().toString();if(i.displayName||(i.displayName=`genaiBatchJob_${o}`),i.dest===void 0){const r=this.getGcsUri(e),s=this.getBigqueryUri(e);if(r)r.endsWith(".jsonl")?i.dest=`${r.slice(0,-6)}/dest`:i.dest=`${r}_dest_${o}`;else if(s)i.dest=`${s}_dest_${o}`;else throw new Error("Unsupported source for Vertex AI: No GCS or BigQuery URI found.")}return i}async createInternal(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=dy(this.apiClient,e);return l=Ee("batchPredictionJobs",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json()),s.then(f=>Da(f))}else{const c=Uu(this.apiClient,e);return l=Ee("{model}:batchGenerateContent",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"POST",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json()),s.then(f=>xr(f))}}async createEmbeddingsInternal(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=hy(this.apiClient,e);return r=Ee("{model}:asyncBatchEmbedContent",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>xr(d))}}async get(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=Iy(this.apiClient,e);return l=Ee("batchPredictionJobs/{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json()),s.then(f=>Da(f))}else{const c=Cy(this.apiClient,e);return l=Ee("batches/{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json()),s.then(f=>xr(f))}}async cancel(e){var t,i,o,r;let s="",l={};if(this.apiClient.isVertexAI()){const d=sy(this.apiClient,e);s=Ee("batchPredictionJobs/{name}:cancel",d._url),l=d._query,delete d._url,delete d._query,await this.apiClient.request({path:s,queryParams:l,body:JSON.stringify(d),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal})}else{const d=ry(this.apiClient,e);s=Ee("batches/{name}:cancel",d._url),l=d._query,delete d._url,delete d._query,await this.apiClient.request({path:s,queryParams:l,body:JSON.stringify(d),httpMethod:"POST",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal})}}async listInternal(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=Fy(e);return l=Ee("batchPredictionJobs",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=ky(f),h=new Pu;return Object.assign(h,p),h})}else{const c=Uy(e);return l=Ee("batches",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=By(f),h=new Pu;return Object.assign(h,p),h})}}async delete(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=my(this.apiClient,e);return l=Ee("batchPredictionJobs/{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"DELETE",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>_y(f))}else{const c=py(this.apiClient,e);return l=Ee("batches/{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"DELETE",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>gy(f))}}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class ME extends Zn{constructor(e){super(),this.apiClient=e,this.list=async(t={})=>new Ri(Kn.PAGED_ITEM_CACHED_CONTENTS,i=>this.listInternal(i),await this.listInternal(t),t)}async create(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=Jy(this.apiClient,e);return l=Ee("cachedContents",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json()),s.then(f=>f)}else{const c=Yy(this.apiClient,e);return l=Ee("cachedContents",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"POST",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json()),s.then(f=>f)}}async get(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=rE(this.apiClient,e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json()),s.then(f=>f)}else{const c=oE(this.apiClient,e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json()),s.then(f=>f)}}async delete(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=Zy(this.apiClient,e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"DELETE",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=jy(f),h=new Ru;return Object.assign(h,p),h})}else{const c=Ky(this.apiClient,e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"DELETE",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=Qy(f),h=new Ru;return Object.assign(h,p),h})}}async update(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=TE(this.apiClient,e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"PATCH",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json()),s.then(f=>f)}else{const c=xE(this.apiClient,e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"PATCH",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json()),s.then(f=>f)}}async listInternal(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=dE(e);return l=Ee("cachedContents",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=hE(f),h=new bu;return Object.assign(h,p),h})}else{const c=uE(e);return l=Ee("cachedContents",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=fE(f),h=new bu;return Object.assign(h,p),h})}}}function Nr(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,i=Object.getOwnPropertySymbols(n);o<i.length;o++)e.indexOf(i[o])<0&&Object.prototype.propertyIsEnumerable.call(n,i[o])&&(t[i[o]]=n[i[o]]);return t}function ku(n){var e=typeof Symbol=="function"&&Symbol.iterator,t=e&&n[e],i=0;if(t)return t.call(n);if(n&&typeof n.length=="number")return{next:function(){return n&&i>=n.length&&(n=void 0),{value:n&&n[i++],done:!n}}};throw new TypeError(e?"Object is not iterable.":"Symbol.iterator is not defined.")}function Ye(n){return this instanceof Ye?(this.v=n,this):new Ye(n)}function Sn(n,e,t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var i=t.apply(n,e||[]),o,r=[];return o=Object.create((typeof AsyncIterator=="function"?AsyncIterator:Object).prototype),l("next"),l("throw"),l("return",s),o[Symbol.asyncIterator]=function(){return this},o;function s(m){return function(v){return Promise.resolve(v).then(m,p)}}function l(m,v){i[m]&&(o[m]=function(E){return new Promise(function(g,_){r.push([m,E,g,_])>1||d(m,E)})},v&&(o[m]=v(o[m])))}function d(m,v){try{c(i[m](v))}catch(E){h(r[0][3],E)}}function c(m){m.value instanceof Ye?Promise.resolve(m.value.v).then(f,p):h(r[0][2],m)}function f(m){d("next",m)}function p(m){d("throw",m)}function h(m,v){m(v),r.shift(),r.length&&d(r[0][0],r[0][1])}}function xn(n){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e=n[Symbol.asyncIterator],t;return e?e.call(n):(n=typeof ku=="function"?ku(n):n[Symbol.iterator](),t={},i("next"),i("throw"),i("return"),t[Symbol.asyncIterator]=function(){return this},t);function i(r){t[r]=n[r]&&function(s){return new Promise(function(l,d){s=n[r](s),o(l,d,s.done,s.value)})}}function o(r,s,l,d){Promise.resolve(d).then(function(c){r({value:c,done:l})},s)}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class TM extends Zn{constructor(e){super(),this.apiClient=e,this.list=async t=>new Ri(Kn.PAGED_ITEM_DOCUMENTS,i=>this.listInternal({parent:t.parent,config:i.config}),await this.listInternal(t),t)}async get(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=yM(e);return r=Ee("{name}",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>d)}}async delete(e){var t,i;let o="",r={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const s=vM(e);o=Ee("{name}",s._url),r=s._query,delete s._url,delete s._query,await this.apiClient.request({path:o,queryParams:r,body:JSON.stringify(s),httpMethod:"DELETE",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal})}}async listInternal(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=SM(e);return r=Ee("{parent}/documents",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>{const c=xM(d),f=new N0;return Object.assign(f,c),f})}}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class MM extends Zn{constructor(e,t=new TM(e)){super(),this.apiClient=e,this.documents=t,this.list=async(i={})=>new Ri(Kn.PAGED_ITEM_FILE_SEARCH_STORES,o=>this.listInternal(o),await this.listInternal(i),i)}async uploadToFileSearchStore(e){if(this.apiClient.isVertexAI())throw new Error("Vertex AI does not support uploading files to a file search store.");return this.apiClient.uploadFileToFileSearchStore(e.fileSearchStoreName,e.file,e.config)}async create(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=dT(e);return r=Ee("fileSearchStores",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>d)}}async get(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=pT(e);return r=Ee("{name}",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>d)}}async delete(e){var t,i;let o="",r={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const s=hT(e);o=Ee("{name}",s._url),r=s._query,delete s._url,delete s._query,await this.apiClient.request({path:o,queryParams:r,body:JSON.stringify(s),httpMethod:"DELETE",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal})}}async listInternal(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=ET(e);return r=Ee("fileSearchStores",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>{const c=ST(d),f=new D0;return Object.assign(f,c),f})}}async uploadToFileSearchStoreInternal(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=xT(e);return r=Ee("upload/v1beta/{file_search_store_name}:uploadToFileSearchStore",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>{const c=TT(d),f=new L0;return Object.assign(f,c),f})}}async importFile(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=_T(e);return r=Ee("{file_search_store_name}:importFile",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json()),o.then(d=>{const c=gT(d),f=new ol;return Object.assign(f,c),f})}}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class xA extends Zn{constructor(e){super(),this.apiClient=e,this.list=async(t={})=>new Ri(Kn.PAGED_ITEM_TUNING_JOBS,i=>this.listInternal(i),await this.listInternal(t),t),this.get=async t=>await this.getInternal(t),this.tune=async t=>{var i;if(this.apiClient.isVertexAI())if(t.baseModel.startsWith("projects/")){const o={tunedModelName:t.baseModel};!((i=t.config)===null||i===void 0)&&i.preTunedModelCheckpointId&&(o.checkpointId=t.config.preTunedModelCheckpointId);const r=Object.assign(Object.assign({},t),{preTunedModel:o});return r.baseModel=void 0,await this.tuneInternal(r)}else{const o=Object.assign({},t);return await this.tuneInternal(o)}else{const o=Object.assign({},t),r=await this.tuneMldevInternal(o);let s="";return r.metadata!==void 0&&r.metadata.tunedModel!==void 0?s=r.metadata.tunedModel:r.name!==void 0&&r.name.includes("/operations/")&&(s=r.name.split("/operations/")[0]),{name:s,state:Ra.JOB_STATE_QUEUED}}}}async getInternal(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=dA(e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>Ha(f))}else{const c=uA(e);return l=Ee("{name}",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>Lf(f))}}async listInternal(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=mA(e);return l=Ee("tuningJobs",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=_A(f),h=new Iu;return Object.assign(h,p),h})}else{const c=pA(e);return l=Ee("tunedModels",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"GET",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=gA(f),h=new Iu;return Object.assign(h,p),h})}}async cancel(e){var t,i,o,r;let s,l="",d={};if(this.apiClient.isVertexAI()){const c=iA(e);return l=Ee("{name}:cancel",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=rA(f),h=new wu;return Object.assign(h,p),h})}else{const c=nA(e);return l=Ee("{name}:cancel",c._url),d=c._query,delete c._url,delete c._query,s=this.apiClient.request({path:l,queryParams:d,body:JSON.stringify(c),httpMethod:"POST",httpOptions:(o=e.config)===null||o===void 0?void 0:o.httpOptions,abortSignal:(r=e.config)===null||r===void 0?void 0:r.abortSignal}).then(f=>f.json().then(p=>{const h=p;return h.sdkHttpResponse={headers:f.headers},h})),s.then(f=>{const p=oA(f),h=new wu;return Object.assign(h,p),h})}}async tuneInternal(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI()){const l=cA(e,e);return r=Ee("tuningJobs",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json().then(c=>{const f=c;return f.sdkHttpResponse={headers:d.headers},f})),o.then(d=>Ha(d))}else throw new Error("This method is only supported by the Vertex AI.")}async tuneMldevInternal(e){var t,i;let o,r="",s={};if(this.apiClient.isVertexAI())throw new Error("This method is only supported by the Gemini Developer API.");{const l=lA(e);return r=Ee("tunedModels",l._url),s=l._query,delete l._url,delete l._query,o=this.apiClient.request({path:r,queryParams:s,body:JSON.stringify(l),httpMethod:"POST",httpOptions:(t=e.config)===null||t===void 0?void 0:t.httpOptions,abortSignal:(i=e.config)===null||i===void 0?void 0:i.abortSignal}).then(d=>d.json().then(c=>{const f=c;return f.sdkHttpResponse={headers:d.headers},f})),o.then(d=>SA(d))}}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
The image keywords should be descriptive enough to get a relevant high-quality image.`,Et=`Generate a website content object in JSON format based on the following context:
...
`),document.getElementById("ctaSettingsInput").value=`${$.title} | ${$.btn}`,document.getElementById("heroImageInput").value=L.heroImageUrl||"",document.getElementById("aboutImageInput").value=L.aboutImageUrl||"",document.getElementById("servicesImageInput").value=L.servicesImageUrl||"",it("Design complete! Switched to Content tab to review results.","success");const $e=document.querySelector('.tab-btn[data-tab="tab-content"]');$e&&$e.click()}catch(pe){console.error("AI Gen error:",pe);const De=pe instanceof Error?pe.message:String(pe);it("AI Gen failed: "+De,"error")}finally{O&&(O.innerHTML=Ke,O.disabled=!1),re&&(re.disabled=!1,re.innerHTML='<i data-lucide="brain-circuit"></i> Run AI Generation Phase'),window.lucide&&window.lucide.createIcons()}};O&&(O.onclick=ie),re&&(re.onclick=ie);const ye=()=>{const k=document.getElementById("categorySelector"),b=document.getElementById("siteCategory");if(!k||!b)return;k.querySelectorAll(".category-option").forEach(J=>{J.addEventListener("click",()=>{Ie(J.getAttribute("data-value"))})})},Ie=k=>{const b=document.getElementById("categorySelector"),U=document.getElementById("siteCategory");if(!b||!U)return;b.querySelectorAll(".category-option").forEach(j=>{j.getAttribute("data-value")===k?j.classList.add("active"):j.classList.remove("active")}),U.value=k},Te=(k=null)=>{const b=document.getElementById("addWebsiteModal");if(b)if(b.style.display="block",k)Ie(k);else{document.querySelectorAll(".category-option").forEach(j=>j.classList.remove("active"));const J=document.getElementById("siteCategory");J&&(J.value="")}};ye();const ze=document.querySelector(".cursor-dot"),mt=document.querySelector(".cursor-outline");ze&&mt&&(window.addEventListener("mousemove",b=>{const U=b.clientX,J=b.clientY;ze.style.left=`${U}px`,ze.style.top=`${J}px`,mt.animate({left:`${U}px`,top:`${J}px`},{duration:500,fill:"forwards"})}),document.querySelectorAll("a, button, .logo, .nav-links li, .stat-item, .bento-item, .gallery-item, .social-links a").forEach(b=>{b.addEventListener("mouseenter",()=>{ze.classList.add("active"),mt.classList.add("active")}),b.addEventListener("mouseleave",()=>{ze.classList.remove("active"),mt.classList.remove("active")})}));const yt=document.querySelector(".hero-content");yt&&window.addEventListener("mousemove",k=>{const b=(k.clientX-window.innerWidth/2)*.01,U=(k.clientY-window.innerHeight/2)*.01;yt.style.transform=`translate(${b}px, ${U}px)`});const ne=()=>{const k=document.querySelectorAll(".stat-item h3");k.length&&k.forEach(b=>{const U=parseInt(b.getAttribute("data-target"));if(isNaN(U))return;let J=0;const K=U/(2e3/16),de=()=>{J+=K,J<U?(b.innerText=Math.ceil(J),requestAnimationFrame(de)):b.innerText=U+(b.innerText.includes("+")?"+":"")};de()})},he={threshold:.15,rootMargin:"0px 0px -50px 0px"},me=new IntersectionObserver((k,b)=>{k.forEach(U=>{U.isIntersecting&&(U.target.classList.add("active"),U.target.classList.contains("stats")&&ne(),b.unobserve(U.target))})},he),Ve=k=>{(k||document.querySelectorAll(".reveal:not(.active)")).forEach(U=>{!U.classList.contains("reveal-left")&&!U.classList.contains("reveal-right")&&U.classList.add("reveal-up"),me.observe(U)})};Ve(),new MutationObserver(k=>{k.forEach(b=>{b.addedNodes.forEach(U=>{if(U.nodeType===1){U.classList.contains("reveal")&&Ve([U]);const J=U.querySelectorAll(".reveal");J.length>0&&Ve(J)}})})}).observe(document.body,{childList:!0,subtree:!0}),(()=>{document.querySelectorAll(".service-card").forEach(b=>{b.addEventListener("mousemove",U=>{const J=b.getBoundingClientRect(),j=U.clientX-J.left,K=U.clientY-J.top;b.style.setProperty("--mouse-x",`${j}px`),b.style.setProperty("--mouse-y",`${K}px`)})})})();try{OA()}catch(k){console.error("Failed to initialize 3D background:",k)}fetch("/api/health").then(k=>k.json()).then(k=>console.log("Server health check:",k)).catch(k=>console.warn("Server health check failed. Backend might be unreachable.",k));const At=document.getElementById("navbar"),Xe=document.querySelector(".hamburger"),tt=document.querySelector(".nav-links"),ht=document.querySelectorAll(".nav-links a");document.getElementById("openAddModal"),window.addEventListener("scroll",()=>{At&&(window.scrollY>50?At.classList.add("sticky"):At.classList.remove("sticky"))}),Xe&&tt&&(Xe.addEventListener("click",k=>{k.stopPropagation(),Xe.classList.toggle("active"),tt.classList.toggle("active");const b=Xe.querySelectorAll("span");b.length>=3&&(tt.classList.contains("active")?(b[0].style.transform="rotate(45deg) translate(5px, 5px)",b[1].style.opacity="0",b[2].style.transform="rotate(-45deg) translate(7px, -7px)"):(b[0].style.transform="none",b[1].style.opacity="1",b[2].style.transform="none"))}),document.addEventListener("click",k=>{if(tt.classList.contains("active")&&!tt.contains(k.target)&&!Xe.contains(k.target)){Xe.classList.remove("active"),tt.classList.remove("active");const b=Xe.querySelectorAll("span");b.length>=3&&(b.forEach(U=>U.style.transform="none"),b[1].style.opacity="1")}})),ht&&Xe&&tt&&ht.forEach(k=>{k.addEventListener("click",()=>{Xe.classList.remove("active"),tt.classList.remove("active");const b=Xe.querySelectorAll("span");b.length>=3&&(b.forEach(U=>U.style.transform="none"),b[1].style.opacity="1")})}),document.querySelectorAll('a[href^="#"]').forEach(k=>{k.addEventListener("click",function(b){const U=this.getAttribute("href");if(U!=="#"){b.preventDefault();try{const J=document.querySelector(U);J&&J.scrollIntoView({behavior:"smooth"})}catch{console.warn("Invalid selector:",U)}}})});const qe=document.getElementById("contactForm");if(qe){const k=new URLSearchParams(window.location.search),b=k.get("service"),U=k.get("interest"),J=k.get("package");if(b){const j=document.getElementById("contactService");j&&(j.value=b)}if(J){const j=document.getElementById("contactService"),K=document.getElementById("contactMessage");let de="",xe="";J==="starter"?(de="Starter Presence",xe="Starter Presence"):J==="growth"?(de="Business Growth",xe="Business Growth"):J==="pro"||J==="generator"?(de="Pro Conversion System",xe="Pro Conversion System"):J==="enterprise"&&(de="Enterprise SaaS System",xe="Enterprise SaaS"),j&&xe&&(j.value=xe),K&&de&&(K.value=`I am interested in the elite "${de}" package and architecting a high-performance digital presence.`)}if(U){const j=document.getElementById("contactMessage"),K=document.getElementById("contactService");j&&(j.value=`I am interested in the "${U}" website from your marketplace. I would like to discuss the details and acquisition process.`),K&&(K.value="web-design")}qe.addEventListener("submit",async j=>{j.preventDefault();const K=qe.querySelector('button[type="submit"]'),de=K?K.innerText:"Submit";K&&(K.innerText="Submitting Inquiry...",K.disabled=!0);const xe=new FormData(qe),et={name:xe.get("name"),email:xe.get("email"),phone:xe.get("phone"),service:xe.get("service"),message:xe.get("message"),status:"New",createdAt:ci()};try{await Xi(Bt(Mt,"inquiries"),et);try{await fetch("/api/consultation",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(et)})}catch(Ke){console.warn("Email API ping failed, but DB saved successfully.",Ke)}qe.innerHTML=`
        ...
        `;const k=rn(Bt(Mt,"inquiries"),ni("createdAt","desc"));at=ti(k,b=>{if(console.log(`>>> [Admin] Inquiries snapshot received. Size: ${b.size}`),b.empty){h.innerHTML=`
            ...
            `,h.appendChild(j);const K=j.querySelector("tbody");b.forEach(Ke=>{const pe=Ke.data(),De=Ke.id,nt=pe.status||"New";let Et="Just now";pe.createdAt&&(pe.createdAt.seconds?Et=new Date(pe.createdAt.seconds*1e3).toLocaleString():pe.createdAt instanceof Date?Et=pe.createdAt.toLocaleString():typeof pe.createdAt=="string"&&(Et=new Date(pe.createdAt).toLocaleString()));const Nt=document.createElement("tr");Nt.style.borderBottom="1px solid rgba(255,255,255,0.1)";const Ht=De.substring(0,6)+"...",T=pe.message&&pe.message.length>30?pe.message.substring(0,30)+"...":pe.message;Nt.innerHTML=`
                    ...
                    <td style="padding: 12px;" title="${pe.message||""}">${T||"-"}</td>
...
We will now explicitly break out of the iframe and auto-open the application in a new tab for you to log in securely. Please hit Sign In on the new tab.`),window.open(window.location.href,"_blank")}else it("Sign In failed: "+j.message,"error")}}),s&&(s.onclick=async k=>{k.preventDefault(),console.log("Admin Logout button clicked"),await Fe()});const Re=document.getElementById("testConnectionBtn");Re&&(Re.onclick=async()=>{if(Z){it("Initiating test flow...","info");try{const U=await(await fetch("/api/consultation",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:"Admin Test",email:"quicksitekenya@gmail.com",service:"System Test",message:"This is a test inquiry to verify the notification and dashboard flow."})})).json();U.success?(it("Test flow successful! Check your email and dashboard.","success"),pt()):it("Test flow failed: "+U.error,"error")}catch(k){it("Test flow error: "+k.message,"error")}}}),v&&E&&(E.onclick=()=>v.style.display="none",window.addEventListener("click",k=>{k.target===v&&(v.style.display="none")})),g&&g.addEventListener("submit",async k=>{if(k.preventDefault(),!Z){it("Unauthorized: Only administrators can list websites.","error");return}const b=document.getElementById("siteName").value,U=document.getElementById("siteCategory").value,J=document.getElementById("sitePrice").value,j=document.getElementById("siteDesc").value,K=document.getElementById("siteLink").value,de=document.getElementById("siteImage").value,xe=g.querySelector('button[type="submit"]'),et=xe.innerText;xe.innerText="Publishing...",xe.disabled=!0;try{await Xi(Bt(Mt,"marketplaceItems"),{name:b,category:U,price:J,desc:j,img:de,link:K,createdAt:ci()}),g.reset(),document.querySelectorAll(".category-option").forEach(De=>De.classList.remove("active"));const pe=document.getElementById("siteCategory");pe&&(pe.value=""),v&&(v.style.display="none"),it("Website submitted successfully!")}catch(Ke){se(Ke,le.WRITE,"marketplaceItems")}finally{xe.innerText=et,xe.disabled=!1}});let Se;const Ze=()=>{const k=document.getElementById("liveSlider"),b=document.getElementById("prevSlide"),U=document.getElementById("nextSlide");if(k&&b&&U){Se&&clearInterval(Se);let J=0;const K=k.querySelectorAll(".slide").length;if(K>0){const de=()=>{k.style.transform=`translateX(-${J*100}%)`};U.onclick=()=>{J=(J+1)%K,de()},b.onclick=()=>{J=(J-1+K)%K,de()},Se=setInterval(()=>{J=(J+1)%K,de()},5e3)}}},F=()=>{const k=document.getElementById("liveSlider");if(!k)return;fe&&(fe(),fe=null);const b=rn(Bt(Mt,"marketplaceItems"),ni("createdAt","desc"));fe=ti(b,U=>{k.querySelectorAll(".dynamic-slide").forEach(K=>K.remove());const j=k.querySelector(".no-items-message");j&&!U.empty?j.style.display="none":j&&U.empty&&(j.style.display="block"),U.forEach(K=>{const de=K.data();if(!de)return;const xe=de.name||"Unnamed Project",et=de.desc||"Premium digital asset.",Ke=$i(de.img,xe,1200,600),pe=document.createElement("div");pe.className="slide dynamic-slide",pe.innerHTML=`
            ...
            `,_&&(document.querySelectorAll(".firestore-error-msg").forEach(nt=>nt.remove()),_.parentElement.insertBefore(pe,_))}throw new Error(JSON.stringify(J))},Ae=()=>{if(!_)return;Ce&&(Ce(),Ce=null);const k=rn(Bt(Mt,"marketplaceItems"),ni("createdAt","desc"));Ce=ti(k,b=>{if(_.innerHTML="",b.empty){_.innerHTML=`
        ...
        `;const j=J.querySelector(".marketplace-grid");b.forEach(K=>{const de=K.name||"Unnamed Project",xe=K.price||"0",et=K.desc||"No description available.",Ke=K.category||"Elite Website",pe=K.link||"#",De=$i(K.img,de),nt=document.createElement("div");nt.className="marketplace-item dynamic-item";const Et=isNaN(Number(xe))?xe:Number(xe).toLocaleString(),Nt=Z?`
        ...
        `;const j=J.querySelector(".portfolio-grid");b.forEach(K=>{const de=K.name||"Unnamed Project",xe=K.category||"Elite Website",et=K.link||"#",Ke=$i(K.img,de),pe=document.createElement("div");pe.className="portfolio-item dynamic-item",pe.innerHTML=`
            ...
            `,j.appendChild(pe)}),U.appendChild(J)};let dt=null;const ft=()=>{if(!A)return;dt&&(dt(),dt=null);const k=rn(Bt(Mt,"marketplaceItems"),ni("createdAt","desc"),pl(3));dt=ti(k,b=>{A.querySelectorAll(".dynamic-item").forEach(j=>j.remove());const J=A.querySelector(".static-fallback");J&&!b.empty?J.style.display="none":J&&b.empty&&(J.style.display="block"),b.forEach((j,K)=>{const de=j.data();if(!de)return;const xe=de.name||"Unnamed Project",et=de.category||"Elite Website",Ke=de.desc||"No description available.",pe=de.link||"#",De=$i(de.img,xe,1200,800),nt=K%2!==0,Et=document.createElement("div");Et.className=`featured-grid dynamic-item reveal ${nt?"reverse reveal-right":"reveal-left"}`,Et.style.marginBottom="60px",Et.innerHTML=`
