...
#define LOW_PRECISION`),e}const $h={[Ir]:"SHADOWMAP_TYPE_PCF",[qi]:"SHADOWMAP_TYPE_VSM"};function Kh(i){return $h[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Zh={[li]:"ENVMAP_TYPE_CUBE",[Ii]:"ENVMAP_TYPE_CUBE",[zr]:"ENVMAP_TYPE_CUBE_UV"};function jh(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Zh[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Jh={[Ii]:"ENVMAP_MODE_REFRACTION"};function Qh(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Jh[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const ep={[Bo]:"ENVMAP_BLENDING_MULTIPLY",[Hl]:"ENVMAP_BLENDING_MIX",[Gl]:"ENVMAP_BLENDING_ADD"};function tp(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":ep[i.combine]||"ENVMAP_BLENDING_NONE"}function np(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function ip(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Kh(t),l=jh(t),f=Qh(t),p=tp(t),d=np(t),m=zh(t),_=Vh(s),S=r.createProgram();let h,u,y=t.glslVersion?"#version "+t.glslVersion+`
...
}`;class wp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new ol(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Mn({vertexShader:Tp,fragmentShader:Ap,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Sn(new Hr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Rp extends Ui{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,f=null,p=null,d=null,m=null,_=null;const S=typeof XRWebGLBinding<"u",h=new wp,u={},y=t.getContextAttributes();let T=null,b=null;const R=[],w=[],U=new dt;let x=null;const E=new jt;E.viewport=new Tt;const Q=new jt;Q.viewport=new Tt;const I=[E,Q],G=new Oc;let z=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ee){let fe=R[ee];return fe===void 0&&(fe=new rs,R[ee]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(ee){let fe=R[ee];return fe===void 0&&(fe=new rs,R[ee]=fe),fe.getGripSpace()},this.getHand=function(ee){let fe=R[ee];return fe===void 0&&(fe=new rs,R[ee]=fe),fe.getHandSpace()};function q(ee){const fe=w.indexOf(ee.inputSource);if(fe===-1)return;const pe=R[fe];pe!==void 0&&(pe.update(ee.inputSource,ee.frame,l||a),pe.dispatchEvent({type:ee.type,data:ee.inputSource}))}function H(){r.removeEventListener("select",q),r.removeEventListener("selectstart",q),r.removeEventListener("selectend",q),r.removeEventListener("squeeze",q),r.removeEventListener("squeezestart",q),r.removeEventListener("squeezeend",q),r.removeEventListener("end",H),r.removeEventListener("inputsourceschange",V);for(let ee=0;ee<R.length;ee++){const fe=w[ee];fe!==null&&(w[ee]=null,R[ee].disconnect(fe))}z=null,$=null,h.reset();for(const ee in u)delete u[ee];e.setRenderTarget(T),m=null,d=null,p=null,r=null,b=null,pt.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(U.width,U.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ee){s=ee,n.isPresenting===!0&&Ve("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ee){o=ee,n.isPresenting===!0&&Ve("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(ee){l=ee},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return p===null&&S&&(p=new XRWebGLBinding(r,t)),p},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(ee){if(r=ee,r!==null){if(T=e.getRenderTarget(),r.addEventListener("select",q),r.addEventListener("selectstart",q),r.addEventListener("selectend",q),r.addEventListener("squeeze",q),r.addEventListener("squeezestart",q),r.addEventListener("squeezeend",q),r.addEventListener("end",H),r.addEventListener("inputsourceschange",V),y.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(U),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let pe=null,ke=null,Ce=null;y.depth&&(Ce=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,pe=y.stencil?oi:Dn,ke=y.stencil?Ki:yn);const Fe={colorFormat:t.RGBA8,depthFormat:Ce,scaleFactor:s};p=this.getBinding(),d=p.createProjectionLayer(Fe),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),b=new vn(d.textureWidth,d.textureHeight,{format:cn,type:Jt,depthTexture:new Zi(d.textureWidth,d.textureHeight,ke,void 0,void 0,void 0,void 0,void 0,void 0,pe),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const pe={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,pe),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),b=new vn(m.framebufferWidth,m.framebufferHeight,{format:cn,type:Jt,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),pt.setContext(r),pt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return h.getDepthTexture()};function V(ee){for(let fe=0;fe<ee.removed.length;fe++){const pe=ee.removed[fe],ke=w.indexOf(pe);ke>=0&&(w[ke]=null,R[ke].disconnect(pe))}for(let fe=0;fe<ee.added.length;fe++){const pe=ee.added[fe];let ke=w.indexOf(pe);if(ke===-1){for(let Fe=0;Fe<R.length;Fe++)if(Fe>=w.length){w.push(pe),ke=Fe;break}else if(w[Fe]===null){w[Fe]=pe,ke=Fe;break}if(ke===-1)break}const Ce=R[ke];Ce&&Ce.connect(pe)}}const se=new k,ne=new k;function ge(ee,fe,pe){se.setFromMatrixPosition(fe.matrixWorld),ne.setFromMatrixPosition(pe.matrixWorld);const ke=se.distanceTo(ne),Ce=fe.projectionMatrix.elements,Fe=pe.projectionMatrix.elements,Mt=Ce[14]/(Ce[10]-1),Ze=Ce[14]/(Ce[10]+1),$e=(Ce[9]+1)/Ce[5],Je=(Ce[9]-1)/Ce[5],qe=(Ce[8]-1)/Ce[0],vt=(Fe[8]+1)/Fe[0],C=Mt*qe,Et=Mt*vt,et=ke/(-qe+vt),tt=et*-qe;if(fe.matrixWorld.decompose(ee.position,ee.quaternion,ee.scale),ee.translateX(tt),ee.translateZ(et),ee.matrixWorld.compose(ee.position,ee.quaternion,ee.scale),ee.matrixWorldInverse.copy(ee.matrixWorld).invert(),Ce[10]===-1)ee.projectionMatrix.copy(fe.projectionMatrix),ee.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const Ae=Mt+et,M=Ze+et,g=C-tt,P=Et+(ke-tt),J=$e*Ze/M*Ae,te=Je*Ze/M*Ae;ee.projectionMatrix.makePerspective(g,P,J,te,Ae,M),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert()}}function ye(ee,fe){fe===null?ee.matrixWorld.copy(ee.matrix):ee.matrixWorld.multiplyMatrices(fe.matrixWorld,ee.matrix),ee.matrixWorldInverse.copy(ee.matrixWorld).invert()}this.updateCamera=function(ee){if(r===null)return;let fe=ee.near,pe=ee.far;h.texture!==null&&(h.depthNear>0&&(fe=h.depthNear),h.depthFar>0&&(pe=h.depthFar)),G.near=Q.near=E.near=fe,G.far=Q.far=E.far=pe,(z!==G.near||$!==G.far)&&(r.updateRenderState({depthNear:G.near,depthFar:G.far}),z=G.near,$=G.far),G.layers.mask=ee.layers.mask|6,E.layers.mask=G.layers.mask&-5,Q.layers.mask=G.layers.mask&-3;const ke=ee.parent,Ce=G.cameras;ye(G,ke);for(let Fe=0;Fe<Ce.length;Fe++)ye(Ce[Fe],ke);Ce.length===2?ge(G,E,Q):G.projectionMatrix.copy(E.projectionMatrix),ve(ee,G,ke)};function ve(ee,fe,pe){pe===null?ee.matrix.copy(fe.matrixWorld):(ee.matrix.copy(pe.matrixWorld),ee.matrix.invert(),ee.matrix.multiply(fe.matrixWorld)),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.updateMatrixWorld(!0),ee.projectionMatrix.copy(fe.projectionMatrix),ee.projectionMatrixInverse.copy(fe.projectionMatrixInverse),ee.isPerspectiveCamera&&(ee.fov=_a*2*Math.atan(1/ee.projectionMatrix.elements[5]),ee.zoom=1)}this.getCamera=function(){return G},this.getFoveation=function(){if(!(d===null&&m===null))return c},this.setFoveation=function(ee){c=ee,d!==null&&(d.fixedFoveation=ee),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=ee)},this.hasDepthSensing=function(){return h.texture!==null},this.getDepthSensingMesh=function(){return h.getMesh(G)},this.getCameraTexture=function(ee){return u[ee]};let He=null;function _t(ee,fe){if(f=fe.getViewerPose(l||a),_=fe,f!==null){const pe=f.views;m!==null&&(e.setRenderTargetFramebuffer(b,m.framebuffer),e.setRenderTarget(b));let ke=!1;pe.length!==G.cameras.length&&(G.cameras.length=0,ke=!0);for(let Ze=0;Ze<pe.length;Ze++){const $e=pe[Ze];let Je=null;if(m!==null)Je=m.getViewport($e);else{const vt=p.getViewSubImage(d,$e);Je=vt.viewport,Ze===0&&(e.setRenderTargetTextures(b,vt.colorTexture,vt.depthStencilTexture),e.setRenderTarget(b))}let qe=I[Ze];qe===void 0&&(qe=new jt,qe.layers.enable(Ze),qe.viewport=new Tt,I[Ze]=qe),qe.matrix.fromArray($e.transform.matrix),qe.matrix.decompose(qe.position,qe.quaternion,qe.scale),qe.projectionMatrix.fromArray($e.projectionMatrix),qe.projectionMatrixInverse.copy(qe.projectionMatrix).invert(),qe.viewport.set(Je.x,Je.y,Je.width,Je.height),Ze===0&&(G.matrix.copy(qe.matrix),G.matrix.decompose(G.position,G.quaternion,G.scale)),ke===!0&&G.cameras.push(qe)}const Ce=r.enabledFeatures;if(Ce&&Ce.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&S){p=n.getBinding();const Ze=p.getDepthInformation(pe[0]);Ze&&Ze.isValid&&Ze.texture&&h.init(Ze,r.renderState)}if(Ce&&Ce.includes("camera-access")&&S){e.state.unbindTexture(),p=n.getBinding();for(let Ze=0;Ze<pe.length;Ze++){const $e=pe[Ze].camera;if($e){let Je=u[$e];Je||(Je=new ol,u[$e]=Je);const qe=p.getCameraImage($e);Je.sourceTexture=qe}}}}for(let pe=0;pe<R.length;pe++){const ke=w[pe],Ce=R[pe];ke!==null&&Ce!==void 0&&Ce.update(ke,fe,l||a)}He&&He(ee,fe),fe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:fe}),_=null}const pt=new ul;pt.setAnimationLoop(_t),this.setAnimationLoop=function(ee){He=ee},this.dispose=function(){}}}const ti=new Un,Cp=new St;function Ip(i,e){function t(h,u){h.matrixAutoUpdate===!0&&h.updateMatrix(),u.value.copy(h.matrix)}function n(h,u){u.color.getRGB(h.fogColor.value,ll(i)),u.isFog?(h.fogNear.value=u.near,h.fogFar.value=u.far):u.isFogExp2&&(h.fogDensity.value=u.density)}function r(h,u,y,T,b){u.isMeshBasicMaterial?s(h,u):u.isMeshLambertMaterial?(s(h,u),u.envMap&&(h.envMapIntensity.value=u.envMapIntensity)):u.isMeshToonMaterial?(s(h,u),p(h,u)):u.isMeshPhongMaterial?(s(h,u),f(h,u),u.envMap&&(h.envMapIntensity.value=u.envMapIntensity)):u.isMeshStandardMaterial?(s(h,u),d(h,u),u.isMeshPhysicalMaterial&&m(h,u,b)):u.isMeshMatcapMaterial?(s(h,u),_(h,u)):u.isMeshDepthMaterial?s(h,u):u.isMeshDistanceMaterial?(s(h,u),S(h,u)):u.isMeshNormalMaterial?s(h,u):u.isLineBasicMaterial?(a(h,u),u.isLineDashedMaterial&&o(h,u)):u.isPointsMaterial?c(h,u,y,T):u.isSpriteMaterial?l(h,u):u.isShadowMaterial?(h.color.value.copy(u.color),h.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(h,u){h.opacity.value=u.opacity,u.color&&h.diffuse.value.copy(u.color),u.emissive&&h.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(h.map.value=u.map,t(u.map,h.mapTransform)),u.alphaMap&&(h.alphaMap.value=u.alphaMap,t(u.alphaMap,h.alphaMapTransform)),u.bumpMap&&(h.bumpMap.value=u.bumpMap,t(u.bumpMap,h.bumpMapTransform),h.bumpScale.value=u.bumpScale,u.side===Ht&&(h.bumpScale.value*=-1)),u.normalMap&&(h.normalMap.value=u.normalMap,t(u.normalMap,h.normalMapTransform),h.normalScale.value.copy(u.normalScale),u.side===Ht&&h.normalScale.value.negate()),u.displacementMap&&(h.displacementMap.value=u.displacementMap,t(u.displacementMap,h.displacementMapTransform),h.displacementScale.value=u.displacementScale,h.displacementBias.value=u.displacementBias),u.emissiveMap&&(h.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,h.emissiveMapTransform)),u.specularMap&&(h.specularMap.value=u.specularMap,t(u.specularMap,h.specularMapTransform)),u.alphaTest>0&&(h.alphaTest.value=u.alphaTest);const y=e.get(u),T=y.envMap,b=y.envMapRotation;T&&(h.envMap.value=T,ti.copy(b),ti.x*=-1,ti.y*=-1,ti.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(ti.y*=-1,ti.z*=-1),h.envMapRotation.value.setFromMatrix4(Cp.makeRotationFromEuler(ti)),h.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,h.reflectivity.value=u.reflectivity,h.ior.value=u.ior,h.refractionRatio.value=u.refractionRatio),u.lightMap&&(h.lightMap.value=u.lightMap,h.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,h.lightMapTransform)),u.aoMap&&(h.aoMap.value=u.aoMap,h.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,h.aoMapTransform))}function a(h,u){h.diffuse.value.copy(u.color),h.opacity.value=u.opacity,u.map&&(h.map.value=u.map,t(u.map,h.mapTransform))}function o(h,u){h.dashSize.value=u.dashSize,h.totalSize.value=u.dashSize+u.gapSize,h.scale.value=u.scale}function c(h,u,y,T){h.diffuse.value.copy(u.color),h.opacity.value=u.opacity,h.size.value=u.size*y,h.scale.value=T*.5,u.map&&(h.map.value=u.map,t(u.map,h.uvTransform)),u.alphaMap&&(h.alphaMap.value=u.alphaMap,t(u.alphaMap,h.alphaMapTransform)),u.alphaTest>0&&(h.alphaTest.value=u.alphaTest)}function l(h,u){h.diffuse.value.copy(u.color),h.opacity.value=u.opacity,h.rotation.value=u.rotation,u.map&&(h.map.value=u.map,t(u.map,h.mapTransform)),u.alphaMap&&(h.alphaMap.value=u.alphaMap,t(u.alphaMap,h.alphaMapTransform)),u.alphaTest>0&&(h.alphaTest.value=u.alphaTest)}function f(h,u){h.specular.value.copy(u.specular),h.shininess.value=Math.max(u.shininess,1e-4)}function p(h,u){u.gradientMap&&(h.gradientMap.value=u.gradientMap)}function d(h,u){h.metalness.value=u.metalness,u.metalnessMap&&(h.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,h.metalnessMapTransform)),h.roughness.value=u.roughness,u.roughnessMap&&(h.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,h.roughnessMapTransform)),u.envMap&&(h.envMapIntensity.value=u.envMapIntensity)}function m(h,u,y){h.ior.value=u.ior,u.sheen>0&&(h.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),h.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(h.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,h.sheenColorMapTransform)),u.sheenRoughnessMap&&(h.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,h.sheenRoughnessMapTransform))),u.clearcoat>0&&(h.clearcoat.value=u.clearcoat,h.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(h.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,h.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(h.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,h.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(h.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,h.clearcoatNormalMapTransform),h.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Ht&&h.clearcoatNormalScale.value.negate())),u.dispersion>0&&(h.dispersion.value=u.dispersion),u.iridescence>0&&(h.iridescence.value=u.iridescence,h.iridescenceIOR.value=u.iridescenceIOR,h.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],h.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(h.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,h.iridescenceMapTransform)),u.iridescenceThicknessMap&&(h.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,h.iridescenceThicknessMapTransform))),u.transmission>0&&(h.transmission.value=u.transmission,h.transmissionSamplerMap.value=y.texture,h.transmissionSamplerSize.value.set(y.width,y.height),u.transmissionMap&&(h.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,h.transmissionMapTransform)),h.thickness.value=u.thickness,u.thicknessMap&&(h.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,h.thicknessMapTransform)),h.attenuationDistance.value=u.attenuationDistance,h.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(h.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(h.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,h.anisotropyMapTransform))),h.specularIntensity.value=u.specularIntensity,h.specularColor.value.copy(u.specularColor),u.specularColorMap&&(h.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,h.specularColorMapTransform)),u.specularIntensityMap&&(h.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,h.specularIntensityMapTransform))}function _(h,u){u.matcap&&(h.matcap.value=u.matcap)}function S(h,u){const y=e.get(u).light;h.referencePosition.value.setFromMatrixPosition(y.matrixWorld),h.nearDistance.value=y.shadow.camera.near,h.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Pp(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,T){const b=T.program;n.uniformBlockBinding(y,b)}function l(y,T){let b=r[y.id];b===void 0&&(_(y),b=f(y),r[y.id]=b,y.addEventListener("dispose",h));const R=T.program;n.updateUBOMapping(y,R);const w=e.render.frame;s[y.id]!==w&&(d(y),s[y.id]=w)}function f(y){const T=p();y.__bindingPointIndex=T;const b=i.createBuffer(),R=y.__size,w=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,R,w),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,b),b}function p(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return it("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const T=r[y.id],b=y.uniforms,R=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let w=0,U=b.length;w<U;w++){const x=Array.isArray(b[w])?b[w]:[b[w]];for(let E=0,Q=x.length;E<Q;E++){const I=x[E];if(m(I,w,E,R)===!0){const G=I.__offset,z=Array.isArray(I.value)?I.value:[I.value];let $=0;for(let q=0;q<z.length;q++){const H=z[q],V=S(H);typeof H=="number"||typeof H=="boolean"?(I.__data[0]=H,i.bufferSubData(i.UNIFORM_BUFFER,G+$,I.__data)):H.isMatrix3?(I.__data[0]=H.elements[0],I.__data[1]=H.elements[1],I.__data[2]=H.elements[2],I.__data[3]=0,I.__data[4]=H.elements[3],I.__data[5]=H.elements[4],I.__data[6]=H.elements[5],I.__data[7]=0,I.__data[8]=H.elements[6],I.__data[9]=H.elements[7],I.__data[10]=H.elements[8],I.__data[11]=0):(H.toArray(I.__data,$),$+=V.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,G,I.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(y,T,b,R){const w=y.value,U=T+"_"+b;if(R[U]===void 0)return typeof w=="number"||typeof w=="boolean"?R[U]=w:R[U]=w.clone(),!0;{const x=R[U];if(typeof w=="number"||typeof w=="boolean"){if(x!==w)return R[U]=w,!0}else if(x.equals(w)===!1)return x.copy(w),!0}return!1}function _(y){const T=y.uniforms;let b=0;const R=16;for(let U=0,x=T.length;U<x;U++){const E=Array.isArray(T[U])?T[U]:[T[U]];for(let Q=0,I=E.length;Q<I;Q++){const G=E[Q],z=Array.isArray(G.value)?G.value:[G.value];for(let $=0,q=z.length;$<q;$++){const H=z[$],V=S(H),se=b%R,ne=se%V.boundary,ge=se+ne;b+=ne,ge!==0&&R-ge<V.storage&&(b+=R-ge),G.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=b,b+=V.storage}}}const w=b%R;return w>0&&(b+=R-w),y.__size=b,y.__cache={},this}function S(y){const T={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(T.boundary=4,T.storage=4):y.isVector2?(T.boundary=8,T.storage=8):y.isVector3||y.isColor?(T.boundary=16,T.storage=12):y.isVector4?(T.boundary=16,T.storage=16):y.isMatrix3?(T.boundary=48,T.storage=48):y.isMatrix4?(T.boundary=64,T.storage=64):y.isTexture?Ve("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ve("WebGLRenderer: Unsupported uniform value type.",y),T}function h(y){const T=y.target;T.removeEventListener("dispose",h);const b=a.indexOf(T.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function u(){for(const y in r)i.deleteBuffer(r[y]);a=[],r={},s={}}return{bind:c,update:l,dispose:u}}const Lp=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let pn=null;function Dp(){return pn===null&&(pn=new bc(Lp,16,16,Pi,Ln),pn.name="DFG_LUT",pn.minFilter=Ot,pn.magFilter=Ot,pn.wrapS=Cn,pn.wrapT=Cn,pn.generateMipmaps=!1,pn.needsUpdate=!0),pn}class Up{constructor(e={}){const{canvas:t=tc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:d=!1,outputBufferType:m=Jt}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const S=m,h=new Set([Ra,wa,Aa]),u=new Set([Jt,yn,$i,Ki,ba,Ta]),y=new Uint32Array(4),T=new Int32Array(4);let b=null,R=null;const w=[],U=[];let x=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=xn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const E=this;let Q=!1;this._outputColorSpace=Zt;let I=0,G=0,z=null,$=-1,q=null;const H=new Tt,V=new Tt;let se=null;const ne=new ct(0);let ge=0,ye=t.width,ve=t.height,He=1,_t=null,pt=null;const ee=new Tt(0,0,ye,ve),fe=new Tt(0,0,ye,ve);let pe=!1;const ke=new rl;let Ce=!1,Fe=!1;const Mt=new St,Ze=new k,$e=new Tt,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let qe=!1;function vt(){return z===null?He:1}let C=n;function Et(v,N){return t.getContext(v,N)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:f,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ma}`),t.addEventListener("webglcontextlost",Te,!1),t.addEventListener("webglcontextrestored",ze,!1),t.addEventListener("webglcontextcreationerror",ut,!1),C===null){const N="webgl2";if(C=Et(N,v),C===null)throw Et(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw it("WebGLRenderer: "+v.message),v}let et,tt,Ae,M,g,P,J,te,j,Se,le,Le,Oe,ie,oe,be,we,ce,Be,D,de,ae,Me;function re(){et=new Uf(C),et.init(),de=new bp(C,et),tt=new Af(C,et,e,de),Ae=new Mp(C,et),tt.reversedDepthBuffer&&d&&Ae.buffers.depth.setReversed(!0),M=new Bf(C),g=new lp,P=new Ep(C,et,Ae,g,tt,de,M),J=new Df(E),te=new Vc(C),ae=new bf(C,te),j=new Nf(C,te,M,ae),Se=new kf(C,j,te,ae,M),ce=new Of(C,tt,P),oe=new wf(g),le=new op(E,J,et,tt,ae,oe),Le=new Ip(E,g),Oe=new dp,ie=new gp(et),we=new Ef(E,J,Ae,Se,_,c),be=new Sp(E,Se,tt),Me=new Pp(C,M,tt,Ae),Be=new Tf(C,et,M),D=new Ff(C,et,M),M.programs=le.programs,E.capabilities=tt,E.extensions=et,E.properties=g,E.renderLists=Oe,E.shadowMap=be,E.state=Ae,E.info=M}re(),S!==Jt&&(x=new Vf(S,t.width,t.height,r,s));const Z=new Rp(E,C);this.xr=Z,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const v=et.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=et.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return He},this.setPixelRatio=function(v){v!==void 0&&(He=v,this.setSize(ye,ve,!1))},this.getSize=function(v){return v.set(ye,ve)},this.setSize=function(v,N,Y=!0){if(Z.isPresenting){Ve("WebGLRenderer: Can't change size while VR device is presenting.");return}ye=v,ve=N,t.width=Math.floor(v*He),t.height=Math.floor(N*He),Y===!0&&(t.style.width=v+"px",t.style.height=N+"px"),x!==null&&x.setSize(t.width,t.height),this.setViewport(0,0,v,N)},this.getDrawingBufferSize=function(v){return v.set(ye*He,ve*He).floor()},this.setDrawingBufferSize=function(v,N,Y){ye=v,ve=N,He=Y,t.width=Math.floor(v*Y),t.height=Math.floor(N*Y),this.setViewport(0,0,v,N)},this.setEffects=function(v){if(S===Jt){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let N=0;N<v.length;N++)if(v[N].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}x.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(H)},this.getViewport=function(v){return v.copy(ee)},this.setViewport=function(v,N,Y,O){v.isVector4?ee.set(v.x,v.y,v.z,v.w):ee.set(v,N,Y,O),Ae.viewport(H.copy(ee).multiplyScalar(He).round())},this.getScissor=function(v){return v.copy(fe)},this.setScissor=function(v,N,Y,O){v.isVector4?fe.set(v.x,v.y,v.z,v.w):fe.set(v,N,Y,O),Ae.scissor(V.copy(fe).multiplyScalar(He).round())},this.getScissorTest=function(){return pe},this.setScissorTest=function(v){Ae.setScissorTest(pe=v)},this.setOpaqueSort=function(v){_t=v},this.setTransparentSort=function(v){pt=v},this.getClearColor=function(v){return v.copy(we.getClearColor())},this.setClearColor=function(){we.setClearColor(...arguments)},this.getClearAlpha=function(){return we.getClearAlpha()},this.setClearAlpha=function(){we.setClearAlpha(...arguments)},this.clear=function(v=!0,N=!0,Y=!0){let O=0;if(v){let B=!1;if(z!==null){const _e=z.texture.format;B=h.has(_e)}if(B){const _e=z.texture.type,Ee=u.has(_e),xe=we.getClearColor(),Ie=we.getClearAlpha(),Ue=xe.r,Xe=xe.g,je=xe.b;Ee?(y[0]=Ue,y[1]=Xe,y[2]=je,y[3]=Ie,C.clearBufferuiv(C.COLOR,0,y)):(T[0]=Ue,T[1]=Xe,T[2]=je,T[3]=Ie,C.clearBufferiv(C.COLOR,0,T))}else O|=C.COLOR_BUFFER_BIT}N&&(O|=C.DEPTH_BUFFER_BIT),Y&&(O|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),O!==0&&C.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Te,!1),t.removeEventListener("webglcontextrestored",ze,!1),t.removeEventListener("webglcontextcreationerror",ut,!1),we.dispose(),Oe.dispose(),ie.dispose(),g.dispose(),J.dispose(),Se.dispose(),ae.dispose(),Me.dispose(),le.dispose(),Z.dispose(),Z.removeEventListener("sessionstart",L),Z.removeEventListener("sessionend",W),K.stop()};function Te(v){v.preventDefault(),Xa("WebGLRenderer: Context Lost."),Q=!0}function ze(){Xa("WebGLRenderer: Context Restored."),Q=!1;const v=M.autoReset,N=be.enabled,Y=be.autoUpdate,O=be.needsUpdate,B=be.type;re(),M.autoReset=v,be.enabled=N,be.autoUpdate=Y,be.needsUpdate=O,be.type=B}function ut(v){it("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function ot(v){const N=v.target;N.removeEventListener("dispose",ot),tn(N)}function tn(v){nn(v),g.remove(v)}function nn(v){const N=g.get(v).programs;N!==void 0&&(N.forEach(function(Y){le.releaseProgram(Y)}),v.isShaderMaterial&&le.releaseShaderCache(v))}this.renderBufferDirect=function(v,N,Y,O,B,_e){N===null&&(N=Je);const Ee=B.isMesh&&B.matrixWorld.determinant()<0,xe=mt(v,N,Y,O,B);Ae.setMaterial(O,Ee);let Ie=Y.index,Ue=1;if(O.wireframe===!0){if(Ie=j.getWireframeAttribute(Y),Ie===void 0)return;Ue=2}const Xe=Y.drawRange,je=Y.attributes.position;let Ne=Xe.start*Ue,ft=(Xe.start+Xe.count)*Ue;_e!==null&&(Ne=Math.max(Ne,_e.start*Ue),ft=Math.min(ft,(_e.start+_e.count)*Ue)),Ie!==null?(Ne=Math.max(Ne,0),ft=Math.min(ft,Ie.count)):je!=null&&(Ne=Math.max(Ne,0),ft=Math.min(ft,je.count));const bt=ft-Ne;if(bt<0||bt===1/0)return;ae.setup(B,O,xe,Y,Ie);let yt,ht=Be;if(Ie!==null&&(yt=te.get(Ie),ht=D,ht.setIndex(yt)),B.isMesh)O.wireframe===!0?(Ae.setLineWidth(O.wireframeLinewidth*vt()),ht.setMode(C.LINES)):ht.setMode(C.TRIANGLES);else if(B.isLine){let Nt=O.linewidth;Nt===void 0&&(Nt=1),Ae.setLineWidth(Nt*vt()),B.isLineSegments?ht.setMode(C.LINES):B.isLineLoop?ht.setMode(C.LINE_LOOP):ht.setMode(C.LINE_STRIP)}else B.isPoints?ht.setMode(C.POINTS):B.isSprite&&ht.setMode(C.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)kr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ht.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(et.get("WEBGL_multi_draw"))ht.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{const Nt=B._multiDrawStarts,Pe=B._multiDrawCounts,Xt=B._multiDrawCount,st=Ie?te.get(Ie).bytesPerElement:1,rn=g.get(O).currentProgram.getUniforms();for(let un=0;un<Xt;un++)rn.setValue(C,"_gl_DrawID",un),ht.render(Nt[un]/st,Pe[un])}else if(B.isInstancedMesh)ht.renderInstances(Ne,bt,B.count);else if(Y.isInstancedBufferGeometry){const Nt=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,Pe=Math.min(Y.instanceCount,Nt);ht.renderInstances(Ne,bt,Pe)}else ht.render(Ne,bt)};function tr(v,N,Y){v.transparent===!0&&v.side===Rn&&v.forceSinglePass===!1?(v.side=Ht,v.needsUpdate=!0,ue(v,N,Y),v.side=$n,v.needsUpdate=!0,ue(v,N,Y),v.side=Rn):ue(v,N,Y)}this.compile=function(v,N,Y=null){Y===null&&(Y=v),R=ie.get(Y),R.init(N),U.push(R),Y.traverseVisible(function(B){B.isLight&&B.layers.test(N.layers)&&(R.pushLight(B),B.castShadow&&R.pushShadow(B))}),v!==Y&&v.traverseVisible(function(B){B.isLight&&B.layers.test(N.layers)&&(R.pushLight(B),B.castShadow&&R.pushShadow(B))}),R.setupLights();const O=new Set;return v.traverse(function(B){if(!(B.isMesh||B.isPoints||B.isLine||B.isSprite))return;const _e=B.material;if(_e)if(Array.isArray(_e))for(let Ee=0;Ee<_e.length;Ee++){const xe=_e[Ee];tr(xe,Y,B),O.add(xe)}else tr(_e,Y,B),O.add(_e)}),R=U.pop(),O},this.compileAsync=function(v,N,Y=null){const O=this.compile(v,N,Y);return new Promise(B=>{function _e(){if(O.forEach(function(Ee){g.get(Ee).currentProgram.isReady()&&O.delete(Ee)}),O.size===0){B(v);return}setTimeout(_e,10)}et.get("KHR_parallel_shader_compile")!==null?_e():setTimeout(_e,10)})};let F=null;function A(v){F&&F(v)}function L(){K.stop()}function W(){K.start()}const K=new ul;K.setAnimationLoop(A),typeof self<"u"&&K.setContext(self),this.setAnimationLoop=function(v){F=v,Z.setAnimationLoop(v),v===null?K.stop():K.start()},Z.addEventListener("sessionstart",L),Z.addEventListener("sessionend",W),this.render=function(v,N){if(N!==void 0&&N.isCamera!==!0){it("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(Q===!0)return;const Y=Z.enabled===!0&&Z.isPresenting===!0,O=x!==null&&(z===null||Y)&&x.begin(E,z);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),Z.enabled===!0&&Z.isPresenting===!0&&(x===null||x.isCompositing()===!1)&&(Z.cameraAutoUpdate===!0&&Z.updateCamera(N),N=Z.getCamera()),v.isScene===!0&&v.onBeforeRender(E,v,N,z),R=ie.get(v,U.length),R.init(N),U.push(R),Mt.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),ke.setFromProjectionMatrix(Mt,_n,N.reversedDepth),Fe=this.localClippingEnabled,Ce=oe.init(this.clippingPlanes,Fe),b=Oe.get(v,w.length),b.init(),w.push(b),Z.enabled===!0&&Z.isPresenting===!0){const Ee=E.xr.getDepthSensingMesh();Ee!==null&&X(Ee,N,-1/0,E.sortObjects)}X(v,N,0,E.sortObjects),b.finish(),E.sortObjects===!0&&b.sort(_t,pt),qe=Z.enabled===!1||Z.isPresenting===!1||Z.hasDepthSensing()===!1,qe&&we.addToRenderList(b,v),this.info.render.frame++,Ce===!0&&oe.beginShadows();const B=R.state.shadowsArray;if(be.render(B,v,N),Ce===!0&&oe.endShadows(),this.info.autoReset===!0&&this.info.reset(),(O&&x.hasRenderPass())===!1){const Ee=b.opaque,xe=b.transmissive;if(R.setupLights(),N.isArrayCamera){const Ie=N.cameras;if(xe.length>0)for(let Ue=0,Xe=Ie.length;Ue<Xe;Ue++){const je=Ie[Ue];De(Ee,xe,v,je)}qe&&we.render(v);for(let Ue=0,Xe=Ie.length;Ue<Xe;Ue++){const je=Ie[Ue];he(b,v,je,je.viewport)}}else xe.length>0&&De(Ee,xe,v,N),qe&&we.render(v),he(b,v,N)}z!==null&&G===0&&(P.updateMultisampleRenderTarget(z),P.updateRenderTargetMipmap(z)),O&&x.end(E),v.isScene===!0&&v.onAfterRender(E,v,N),ae.resetDefaultState(),$=-1,q=null,U.pop(),U.length>0?(R=U[U.length-1],Ce===!0&&oe.setGlobalState(E.clippingPlanes,R.state.camera)):R=null,w.pop(),w.length>0?b=w[w.length-1]:b=null};function X(v,N,Y,O){if(v.visible===!1)return;if(v.layers.test(N.layers)){if(v.isGroup)Y=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(N);else if(v.isLight)R.pushLight(v),v.castShadow&&R.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||ke.intersectsSprite(v)){O&&$e.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Mt);const Ee=Se.update(v),xe=v.material;xe.visible&&b.push(v,Ee,xe,Y,$e.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||ke.intersectsObject(v))){const Ee=Se.update(v),xe=v.material;if(O&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),$e.copy(v.boundingSphere.center)):(Ee.boundingSphere===null&&Ee.computeBoundingSphere(),$e.copy(Ee.boundingSphere.center)),$e.applyMatrix4(v.matrixWorld).applyMatrix4(Mt)),Array.isArray(xe)){const Ie=Ee.groups;for(let Ue=0,Xe=Ie.length;Ue<Xe;Ue++){const je=Ie[Ue],Ne=xe[je.materialIndex];Ne&&Ne.visible&&b.push(v,Ee,Ne,Y,$e.z,je)}}else xe.visible&&b.push(v,Ee,xe,Y,$e.z,null)}}const _e=v.children;for(let Ee=0,xe=_e.length;Ee<xe;Ee++)X(_e[Ee],N,Y,O)}function he(v,N,Y,O){const{opaque:B,transmissive:_e,transparent:Ee}=v;R.setupLightsView(Y),Ce===!0&&oe.setGlobalState(E.clippingPlanes,Y),O&&Ae.viewport(H.copy(O)),B.length>0&&nt(B,N,Y),_e.length>0&&nt(_e,N,Y),Ee.length>0&&nt(Ee,N,Y),Ae.buffers.depth.setTest(!0),Ae.buffers.depth.setMask(!0),Ae.buffers.color.setMask(!0),Ae.setPolygonOffset(!1)}function De(v,N,Y,O){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(R.state.transmissionRenderTarget[O.id]===void 0){const Ne=et.has("EXT_color_buffer_half_float")||et.has("EXT_color_buffer_float");R.state.transmissionRenderTarget[O.id]=new vn(1,1,{generateMipmaps:!0,type:Ne?Ln:Jt,minFilter:ai,samples:Math.max(4,tt.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:rt.workingColorSpace})}const _e=R.state.transmissionRenderTarget[O.id],Ee=O.viewport||H;_e.setSize(Ee.z*E.transmissionResolutionScale,Ee.w*E.transmissionResolutionScale);const xe=E.getRenderTarget(),Ie=E.getActiveCubeFace(),Ue=E.getActiveMipmapLevel();E.setRenderTarget(_e),E.getClearColor(ne),ge=E.getClearAlpha(),ge<1&&E.setClearColor(16777215,.5),E.clear(),qe&&we.render(Y);const Xe=E.toneMapping;E.toneMapping=xn;const je=O.viewport;if(O.viewport!==void 0&&(O.viewport=void 0),R.setupLightsView(O),Ce===!0&&oe.setGlobalState(E.clippingPlanes,O),nt(v,Y,O),P.updateMultisampleRenderTarget(_e),P.updateRenderTargetMipmap(_e),et.has("WEBGL_multisampled_render_to_texture")===!1){let Ne=!1;for(let ft=0,bt=N.length;ft<bt;ft++){const yt=N[ft],{object:ht,geometry:Nt,material:Pe,group:Xt}=yt;if(Pe.side===Rn&&ht.layers.test(O.layers)){const st=Pe.side;Pe.side=Ht,Pe.needsUpdate=!0,Ge(ht,Y,O,Nt,Pe,Xt),Pe.side=st,Pe.needsUpdate=!0,Ne=!0}}Ne===!0&&(P.updateMultisampleRenderTarget(_e),P.updateRenderTargetMipmap(_e))}E.setRenderTarget(xe,Ie,Ue),E.setClearColor(ne,ge),je!==void 0&&(O.viewport=je),E.toneMapping=Xe}function nt(v,N,Y){const O=N.isScene===!0?N.overrideMaterial:null;for(let B=0,_e=v.length;B<_e;B++){const Ee=v[B],{object:xe,geometry:Ie,group:Ue}=Ee;let Xe=Ee.material;Xe.allowOverride===!0&&O!==null&&(Xe=O),xe.layers.test(Y.layers)&&Ge(xe,N,Y,Ie,Xe,Ue)}}function Ge(v,N,Y,O,B,_e){v.onBeforeRender(E,N,Y,O,B,_e),v.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),B.onBeforeRender(E,N,Y,O,v,_e),B.transparent===!0&&B.side===Rn&&B.forceSinglePass===!1?(B.side=Ht,B.needsUpdate=!0,E.renderBufferDirect(Y,N,O,B,v,_e),B.side=$n,B.needsUpdate=!0,E.renderBufferDirect(Y,N,O,B,v,_e),B.side=Rn):E.renderBufferDirect(Y,N,O,B,v,_e),v.onAfterRender(E,N,Y,O,B,_e)}function ue(v,N,Y){N.isScene!==!0&&(N=Je);const O=g.get(v),B=R.state.lights,_e=R.state.shadowsArray,Ee=B.state.version,xe=le.getParameters(v,B.state,_e,N,Y),Ie=le.getProgramCacheKey(xe);let Ue=O.programs;O.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?N.environment:null,O.fog=N.fog;const Xe=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;O.envMap=J.get(v.envMap||O.environment,Xe),O.envMapRotation=O.environment!==null&&v.envMap===null?N.environmentRotation:v.envMapRotation,Ue===void 0&&(v.addEventListener("dispose",ot),Ue=new Map,O.programs=Ue);let je=Ue.get(Ie);if(je!==void 0){if(O.currentProgram===je&&O.lightsStateVersion===Ee)return We(v,xe),je}else xe.uniforms=le.getUniforms(v),v.onBeforeCompile(xe,E),je=le.acquireProgram(xe,Ie),Ue.set(Ie,je),O.uniforms=xe.uniforms;const Ne=O.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Ne.clippingPlanes=oe.uniform),We(v,xe),O.needsLights=Wt(v),O.lightsStateVersion=Ee,O.needsLights&&(Ne.ambientLightColor.value=B.state.ambient,Ne.lightProbe.value=B.state.probe,Ne.directionalLights.value=B.state.directional,Ne.directionalLightShadows.value=B.state.directionalShadow,Ne.spotLights.value=B.state.spot,Ne.spotLightShadows.value=B.state.spotShadow,Ne.rectAreaLights.value=B.state.rectArea,Ne.ltc_1.value=B.state.rectAreaLTC1,Ne.ltc_2.value=B.state.rectAreaLTC2,Ne.pointLights.value=B.state.point,Ne.pointLightShadows.value=B.state.pointShadow,Ne.hemisphereLights.value=B.state.hemi,Ne.directionalShadowMatrix.value=B.state.directionalShadowMatrix,Ne.spotLightMatrix.value=B.state.spotLightMatrix,Ne.spotLightMap.value=B.state.spotLightMap,Ne.pointShadowMatrix.value=B.state.pointShadowMatrix),O.currentProgram=je,O.uniformsList=null,je}function Re(v){if(v.uniformsList===null){const N=v.currentProgram.getUniforms();v.uniformsList=Nr.seqWithValue(N.seq,v.uniforms)}return v.uniformsList}function We(v,N){const Y=g.get(v);Y.outputColorSpace=N.outputColorSpace,Y.batching=N.batching,Y.batchingColor=N.batchingColor,Y.instancing=N.instancing,Y.instancingColor=N.instancingColor,Y.instancingMorph=N.instancingMorph,Y.skinning=N.skinning,Y.morphTargets=N.morphTargets,Y.morphNormals=N.morphNormals,Y.morphColors=N.morphColors,Y.morphTargetsCount=N.morphTargetsCount,Y.numClippingPlanes=N.numClippingPlanes,Y.numIntersection=N.numClipIntersection,Y.vertexAlphas=N.vertexAlphas,Y.vertexTangents=N.vertexTangents,Y.toneMapping=N.toneMapping}function mt(v,N,Y,O,B){N.isScene!==!0&&(N=Je),P.resetTextureUnits();const _e=N.fog,Ee=O.isMeshStandardMaterial||O.isMeshLambertMaterial||O.isMeshPhongMaterial?N.environment:null,xe=z===null?E.outputColorSpace:z.isXRRenderTarget===!0?z.texture.colorSpace:Li,Ie=O.isMeshStandardMaterial||O.isMeshLambertMaterial&&!O.envMap||O.isMeshPhongMaterial&&!O.envMap,Ue=J.get(O.envMap||Ee,Ie),Xe=O.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,je=!!Y.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),Ne=!!Y.morphAttributes.position,ft=!!Y.morphAttributes.normal,bt=!!Y.morphAttributes.color;let yt=xn;O.toneMapped&&(z===null||z.isXRRenderTarget===!0)&&(yt=E.toneMapping);const ht=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,Nt=ht!==void 0?ht.length:0,Pe=g.get(O),Xt=R.state.lights;if(Ce===!0&&(Fe===!0||v!==q)){const It=v===q&&O.id===$;oe.setState(O,v,It)}let st=!1;O.version===Pe.__version?(Pe.needsLights&&Pe.lightsStateVersion!==Xt.state.version||Pe.outputColorSpace!==xe||B.isBatchedMesh&&Pe.batching===!1||!B.isBatchedMesh&&Pe.batching===!0||B.isBatchedMesh&&Pe.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Pe.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Pe.instancing===!1||!B.isInstancedMesh&&Pe.instancing===!0||B.isSkinnedMesh&&Pe.skinning===!1||!B.isSkinnedMesh&&Pe.skinning===!0||B.isInstancedMesh&&Pe.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Pe.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Pe.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Pe.instancingMorph===!1&&B.morphTexture!==null||Pe.envMap!==Ue||O.fog===!0&&Pe.fog!==_e||Pe.numClippingPlanes!==void 0&&(Pe.numClippingPlanes!==oe.numPlanes||Pe.numIntersection!==oe.numIntersection)||Pe.vertexAlphas!==Xe||Pe.vertexTangents!==je||Pe.morphTargets!==Ne||Pe.morphNormals!==ft||Pe.morphColors!==bt||Pe.toneMapping!==yt||Pe.morphTargetsCount!==Nt)&&(st=!0):(st=!0,Pe.__version=O.version);let rn=Pe.currentProgram;st===!0&&(rn=ue(O,N,B));let un=!1,Kn=!1,di=!1;const gt=rn.getUniforms(),Lt=Pe.uniforms;if(Ae.useProgram(rn.program)&&(un=!0,Kn=!0,di=!0),O.id!==$&&($=O.id,Kn=!0),un||q!==v){Ae.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),gt.setValue(C,"projectionMatrix",v.projectionMatrix),gt.setValue(C,"viewMatrix",v.matrixWorldInverse);const Fn=gt.map.cameraPosition;Fn!==void 0&&Fn.setValue(C,Ze.setFromMatrixPosition(v.matrixWorld)),tt.logarithmicDepthBuffer&&gt.setValue(C,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&gt.setValue(C,"isOrthographic",v.isOrthographicCamera===!0),q!==v&&(q=v,Kn=!0,di=!0)}if(Pe.needsLights&&(Xt.state.directionalShadowMap.length>0&&gt.setValue(C,"directionalShadowMap",Xt.state.directionalShadowMap,P),Xt.state.spotShadowMap.length>0&&gt.setValue(C,"spotShadowMap",Xt.state.spotShadowMap,P),Xt.state.pointShadowMap.length>0&&gt.setValue(C,"pointShadowMap",Xt.state.pointShadowMap,P)),B.isSkinnedMesh){gt.setOptional(C,B,"bindMatrix"),gt.setOptional(C,B,"bindMatrixInverse");const It=B.skeleton;It&&(It.boneTexture===null&&It.computeBoneTexture(),gt.setValue(C,"boneTexture",It.boneTexture,P))}B.isBatchedMesh&&(gt.setOptional(C,B,"batchingTexture"),gt.setValue(C,"batchingTexture",B._matricesTexture,P),gt.setOptional(C,B,"batchingIdTexture"),gt.setValue(C,"batchingIdTexture",B._indirectTexture,P),gt.setOptional(C,B,"batchingColorTexture"),B._colorsTexture!==null&&gt.setValue(C,"batchingColorTexture",B._colorsTexture,P));const Nn=Y.morphAttributes;if((Nn.position!==void 0||Nn.normal!==void 0||Nn.color!==void 0)&&ce.update(B,Y,rn),(Kn||Pe.receiveShadow!==B.receiveShadow)&&(Pe.receiveShadow=B.receiveShadow,gt.setValue(C,"receiveShadow",B.receiveShadow)),(O.isMeshStandardMaterial||O.isMeshLambertMaterial||O.isMeshPhongMaterial)&&O.envMap===null&&N.environment!==null&&(Lt.envMapIntensity.value=N.environmentIntensity),Lt.dfgLUT!==void 0&&(Lt.dfgLUT.value=Dp()),Kn&&(gt.setValue(C,"toneMappingExposure",E.toneMappingExposure),Pe.needsLights&&Ct(Lt,di),_e&&O.fog===!0&&Le.refreshFogUniforms(Lt,_e),Le.refreshMaterialUniforms(Lt,O,He,ve,R.state.transmissionRenderTarget[v.id]),Nr.upload(C,Re(Pe),Lt,P)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(Nr.upload(C,Re(Pe),Lt,P),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&gt.setValue(C,"center",B.center),gt.setValue(C,"modelViewMatrix",B.modelViewMatrix),gt.setValue(C,"normalMatrix",B.normalMatrix),gt.setValue(C,"modelMatrix",B.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const It=O.uniformsGroups;for(let Fn=0,ui=It.length;Fn<ui;Fn++){const Fa=It[Fn];Me.update(Fa,rn),Me.bind(Fa,rn)}}return rn}function Ct(v,N){v.ambientLightColor.needsUpdate=N,v.lightProbe.needsUpdate=N,v.directionalLights.needsUpdate=N,v.directionalLightShadows.needsUpdate=N,v.pointLights.needsUpdate=N,v.pointLightShadows.needsUpdate=N,v.spotLights.needsUpdate=N,v.spotLightShadows.needsUpdate=N,v.rectAreaLights.needsUpdate=N,v.hemisphereLights.needsUpdate=N}function Wt(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return I},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return z},this.setRenderTargetTextures=function(v,N,Y){const O=g.get(v);O.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,O.__autoAllocateDepthBuffer===!1&&(O.__useRenderToTexture=!1),g.get(v.texture).__webglTexture=N,g.get(v.depthTexture).__webglTexture=O.__autoAllocateDepthBuffer?void 0:Y,O.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,N){const Y=g.get(v);Y.__webglFramebuffer=N,Y.__useDefaultFramebuffer=N===void 0};const ci=C.createFramebuffer();this.setRenderTarget=function(v,N=0,Y=0){z=v,I=N,G=Y;let O=null,B=!1,_e=!1;if(v){const xe=g.get(v);if(xe.__useDefaultFramebuffer!==void 0){Ae.bindFramebuffer(C.FRAMEBUFFER,xe.__webglFramebuffer),H.copy(v.viewport),V.copy(v.scissor),se=v.scissorTest,Ae.viewport(H),Ae.scissor(V),Ae.setScissorTest(se),$=-1;return}else if(xe.__webglFramebuffer===void 0)P.setupRenderTarget(v);else if(xe.__hasExternalTextures)P.rebindTextures(v,g.get(v.texture).__webglTexture,g.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Xe=v.depthTexture;if(xe.__boundDepthTexture!==Xe){if(Xe!==null&&g.has(Xe)&&(v.width!==Xe.image.width||v.height!==Xe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");P.setupDepthRenderbuffer(v)}}const Ie=v.texture;(Ie.isData3DTexture||Ie.isDataArrayTexture||Ie.isCompressedArrayTexture)&&(_e=!0);const Ue=g.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ue[N])?O=Ue[N][Y]:O=Ue[N],B=!0):v.samples>0&&P.useMultisampledRTT(v)===!1?O=g.get(v).__webglMultisampledFramebuffer:Array.isArray(Ue)?O=Ue[Y]:O=Ue,H.copy(v.viewport),V.copy(v.scissor),se=v.scissorTest}else H.copy(ee).multiplyScalar(He).floor(),V.copy(fe).multiplyScalar(He).floor(),se=pe;if(Y!==0&&(O=ci),Ae.bindFramebuffer(C.FRAMEBUFFER,O)&&Ae.drawBuffers(v,O),Ae.viewport(H),Ae.scissor(V),Ae.setScissorTest(se),B){const xe=g.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+N,xe.__webglTexture,Y)}else if(_e){const xe=N;for(let Ie=0;Ie<v.textures.length;Ie++){const Ue=g.get(v.textures[Ie]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+Ie,Ue.__webglTexture,Y,xe)}}else if(v!==null&&Y!==0){const xe=g.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,xe.__webglTexture,Y)}$=-1},this.readRenderTargetPixels=function(v,N,Y,O,B,_e,Ee,xe=0){if(!(v&&v.isWebGLRenderTarget)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ie=g.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&Ee!==void 0&&(Ie=Ie[Ee]),Ie){Ae.bindFramebuffer(C.FRAMEBUFFER,Ie);try{const Ue=v.textures[xe],Xe=Ue.format,je=Ue.type;if(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+xe),!tt.textureFormatReadable(Xe)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!tt.textureTypeReadable(je)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=v.width-O&&Y>=0&&Y<=v.height-B&&C.readPixels(N,Y,O,B,de.convert(Xe),de.convert(je),_e)}finally{const Ue=z!==null?g.get(z).__webglFramebuffer:null;Ae.bindFramebuffer(C.FRAMEBUFFER,Ue)}}},this.readRenderTargetPixelsAsync=async function(v,N,Y,O,B,_e,Ee,xe=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ie=g.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&Ee!==void 0&&(Ie=Ie[Ee]),Ie)if(N>=0&&N<=v.width-O&&Y>=0&&Y<=v.height-B){Ae.bindFramebuffer(C.FRAMEBUFFER,Ie);const Ue=v.textures[xe],Xe=Ue.format,je=Ue.type;if(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+xe),!tt.textureFormatReadable(Xe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!tt.textureTypeReadable(je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ne=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Ne),C.bufferData(C.PIXEL_PACK_BUFFER,_e.byteLength,C.STREAM_READ),C.readPixels(N,Y,O,B,de.convert(Xe),de.convert(je),0);const ft=z!==null?g.get(z).__webglFramebuffer:null;Ae.bindFramebuffer(C.FRAMEBUFFER,ft);const bt=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await nc(C,bt,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Ne),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,_e),C.deleteBuffer(Ne),C.deleteSync(bt),_e}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,N=null,Y=0){const O=Math.pow(2,-Y),B=Math.floor(v.image.width*O),_e=Math.floor(v.image.height*O),Ee=N!==null?N.x:0,xe=N!==null?N.y:0;P.setTexture2D(v,0),C.copyTexSubImage2D(C.TEXTURE_2D,Y,0,0,Ee,xe,B,_e),Ae.unbindTexture()};const nr=C.createFramebuffer(),Xr=C.createFramebuffer();this.copyTextureToTexture=function(v,N,Y=null,O=null,B=0,_e=0){let Ee,xe,Ie,Ue,Xe,je,Ne,ft,bt;const yt=v.isCompressedTexture?v.mipmaps[_e]:v.image;if(Y!==null)Ee=Y.max.x-Y.min.x,xe=Y.max.y-Y.min.y,Ie=Y.isBox3?Y.max.z-Y.min.z:1,Ue=Y.min.x,Xe=Y.min.y,je=Y.isBox3?Y.min.z:0;else{const Lt=Math.pow(2,-B);Ee=Math.floor(yt.width*Lt),xe=Math.floor(yt.height*Lt),v.isDataArrayTexture?Ie=yt.depth:v.isData3DTexture?Ie=Math.floor(yt.depth*Lt):Ie=1,Ue=0,Xe=0,je=0}O!==null?(Ne=O.x,ft=O.y,bt=O.z):(Ne=0,ft=0,bt=0);const ht=de.convert(N.format),Nt=de.convert(N.type);let Pe;N.isData3DTexture?(P.setTexture3D(N,0),Pe=C.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(P.setTexture2DArray(N,0),Pe=C.TEXTURE_2D_ARRAY):(P.setTexture2D(N,0),Pe=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,N.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,N.unpackAlignment);const Xt=C.getParameter(C.UNPACK_ROW_LENGTH),st=C.getParameter(C.UNPACK_IMAGE_HEIGHT),rn=C.getParameter(C.UNPACK_SKIP_PIXELS),un=C.getParameter(C.UNPACK_SKIP_ROWS),Kn=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,yt.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,yt.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Ue),C.pixelStorei(C.UNPACK_SKIP_ROWS,Xe),C.pixelStorei(C.UNPACK_SKIP_IMAGES,je);const di=v.isDataArrayTexture||v.isData3DTexture,gt=N.isDataArrayTexture||N.isData3DTexture;if(v.isDepthTexture){const Lt=g.get(v),Nn=g.get(N),It=g.get(Lt.__renderTarget),Fn=g.get(Nn.__renderTarget);Ae.bindFramebuffer(C.READ_FRAMEBUFFER,It.__webglFramebuffer),Ae.bindFramebuffer(C.DRAW_FRAMEBUFFER,Fn.__webglFramebuffer);for(let ui=0;ui<Ie;ui++)di&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(v).__webglTexture,B,je+ui),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(N).__webglTexture,_e,bt+ui)),C.blitFramebuffer(Ue,Xe,Ee,xe,Ne,ft,Ee,xe,C.DEPTH_BUFFER_BIT,C.NEAREST);Ae.bindFramebuffer(C.READ_FRAMEBUFFER,null),Ae.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(B!==0||v.isRenderTargetTexture||g.has(v)){const Lt=g.get(v),Nn=g.get(N);Ae.bindFramebuffer(C.READ_FRAMEBUFFER,nr),Ae.bindFramebuffer(C.DRAW_FRAMEBUFFER,Xr);for(let It=0;It<Ie;It++)di?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Lt.__webglTexture,B,je+It):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Lt.__webglTexture,B),gt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Nn.__webglTexture,_e,bt+It):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Nn.__webglTexture,_e),B!==0?C.blitFramebuffer(Ue,Xe,Ee,xe,Ne,ft,Ee,xe,C.COLOR_BUFFER_BIT,C.NEAREST):gt?C.copyTexSubImage3D(Pe,_e,Ne,ft,bt+It,Ue,Xe,Ee,xe):C.copyTexSubImage2D(Pe,_e,Ne,ft,Ue,Xe,Ee,xe);Ae.bindFramebuffer(C.READ_FRAMEBUFFER,null),Ae.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else gt?v.isDataTexture||v.isData3DTexture?C.texSubImage3D(Pe,_e,Ne,ft,bt,Ee,xe,Ie,ht,Nt,yt.data):N.isCompressedArrayTexture?C.compressedTexSubImage3D(Pe,_e,Ne,ft,bt,Ee,xe,Ie,ht,yt.data):C.texSubImage3D(Pe,_e,Ne,ft,bt,Ee,xe,Ie,ht,Nt,yt):v.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,_e,Ne,ft,Ee,xe,ht,Nt,yt.data):v.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,_e,Ne,ft,yt.width,yt.height,ht,yt.data):C.texSubImage2D(C.TEXTURE_2D,_e,Ne,ft,Ee,xe,ht,Nt,yt);C.pixelStorei(C.UNPACK_ROW_LENGTH,Xt),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,st),C.pixelStorei(C.UNPACK_SKIP_PIXELS,rn),C.pixelStorei(C.UNPACK_SKIP_ROWS,un),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Kn),_e===0&&N.generateMipmaps&&C.generateMipmap(Pe),Ae.unbindTexture()},this.initRenderTarget=function(v){g.get(v).__webglFramebuffer===void 0&&P.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?P.setTextureCube(v,0):v.isData3DTexture?P.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?P.setTexture2DArray(v,0):P.setTexture2D(v,0),Ae.unbindTexture()},this.resetState=function(){I=0,G=0,z=null,Ae.reset(),ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return _n}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=rt._getDrawingBufferColorSpace(e),t.unpackColorSpace=rt._getUnpackColorSpace()}}const Np=()=>{console.log("AI Consultation initializing via server-side bridge...");const i=document.createElement("div");i.className="ai-chat-btn",i.innerHTML='<i data-lucide="message-square"></i>',document.body.appendChild(i);const e=document.createElement("div");e.className="ai-chat-window",e.innerHTML=`
...
`):"",document.getElementById("ctaSettingsInput").value=A&&A.cta?`${A.cta.title||""} | ${A.cta.btn||""}`:"",document.getElementById("subscriptionPlanInput").value=A&&A.subscriptionPlan||"Starter Presence",document.getElementById("paymentStatusInput").value=A&&A.paymentStatus||"Unpaid",document.getElementById("setupFeeInput").value=A&&A.setupFee||0,document.getElementById("monthlyFeeInput").value=A&&A.monthlyFee||0,document.getElementById("featuresEnabledInput").value=A&&A.featuresEnabled?A.featuresEnabled.join(", "):"",E.style.display="block"};I&&(I.onsubmit=async F=>{var he,De,nt,Ge,ue;F.preventDefault();const A=document.getElementById("editSiteId").value,L=I.querySelector('button[type="submit"]');L.disabled=!0,L.innerText="Publishing Instant Update...";const K=document.getElementById("servicesInput").value.split(`
`).filter(Re=>Re.includes("|")).map(Re=>{const We=Re.split("|");return{name:We[0].trim(),price:We[1].trim(),description:(We[2]||"").trim()}}),X={clientName:document.getElementById("clientNameInput").value,businessName:document.getElementById("businessNameInput").value,plan:document.getElementById("planInput").value,template:document.getElementById("templateInput").value,tagline:document.getElementById("taglineInput").value,aboutText:document.getElementById("aboutTextInput").value,contact:{phone:document.getElementById("phoneInput").value,whatsapp:document.getElementById("whatsappInput").value,address:document.getElementById("addressInput").value,mapUrl:document.getElementById("mapUrlInput").value},customDomain:document.getElementById("customDomainInput").value,custom_domains:document.getElementById("customDomainsListInput").value.split(",").map(Re=>Re.trim()).filter(Re=>Re),subdomain:document.getElementById("subdomainInput").value,template_type:document.getElementById("templateInput").value,subscriptionPlan:document.getElementById("subscriptionPlanInput").value,paymentStatus:document.getElementById("paymentStatusInput").value,setupFee:parseFloat(document.getElementById("setupFeeInput").value)||0,monthlyFee:parseFloat(document.getElementById("monthlyFeeInput").value)||0,featuresEnabled:document.getElementById("featuresEnabledInput").value.split(",").map(Re=>Re.trim()).filter(Re=>Re),hero:{title:((he=document.getElementById("heroSettingsInput").value.split("|")[0])==null?void 0:he.trim())||"",subtitle:((De=document.getElementById("heroSettingsInput").value.split("|")[1])==null?void 0:De.trim())||"",cta:((nt=document.getElementById("heroSettingsInput").value.split("|")[2])==null?void 0:nt.trim())||""},features:document.getElementById("featuresInput").value.split(`
`).filter(Re=>Re.includes("|")).map(Re=>{const[We,mt,Ct]=Re.split("|").map(Wt=>Wt.trim());return{title:We,desc:mt,icon:Ct||"check"}}),testimonials:document.getElementById("testimonialsInput").value.split(`
`).filter(Re=>Re.includes("|")).map(Re=>{const[We,mt]=Re.split("|").map(Ct=>Ct.trim());return{name:We,quote:mt}}),pricing:document.getElementById("pricingInput").value.split(`
`).filter(Re=>Re.includes("|")).map(Re=>{const[We,mt,Ct]=Re.split("|").map(Wt=>Wt.trim());return{plan:We,price:mt,features:Ct?Ct.split(",").map(Wt=>Wt.trim()):[]}}),cta:{title:((Ge=document.getElementById("ctaSettingsInput").value.split("|")[0])==null?void 0:Ge.trim())||"",btn:((ue=document.getElementById("ctaSettingsInput").value.split("|")[1])==null?void 0:ue.trim())||""},images:{hero:document.getElementById("heroImageInput").value,logo:document.getElementById("logoImageInput").value,gallery:document.getElementById("galleryImagesInput").value.split(`
`).filter(Re=>Re.trim())},services:K,status:document.getElementById("statusInput").value,updatedAt:ni()};try{A?(await qr(kn(xt,"clientSites",A),X),at("Website Updated Live!")):(X.createdAt=ni(),await Xi(Dt(xt,"clientSites"),X),at("New Client Site Created!")),E.style.display="none"}catch(Re){Be(Re,A?ce.UPDATE:ce.CREATE,"clientSites")}finally{L.disabled=!1,L.innerText="Save → Website Live"}}),G&&(G.onclick=()=>{const F=document.getElementById("editSiteId").value;if(!F){at("Save the site first to generate a preview link.","info");return}window.open(`site.html?id=${F}&preview=true`,"_blank")});const V=()=>{const F=document.getElementById("categorySelector"),A=document.getElementById("siteCategory");if(!F||!A)return;F.querySelectorAll(".category-option").forEach(W=>{W.addEventListener("click",()=>{se(W.getAttribute("data-value"))})})},se=F=>{const A=document.getElementById("categorySelector"),L=document.getElementById("siteCategory");if(!A||!L)return;A.querySelectorAll(".category-option").forEach(K=>{K.getAttribute("data-value")===F?K.classList.add("active"):K.classList.remove("active")}),L.value=F},ne=(F=null)=>{const A=document.getElementById("addWebsiteModal");if(A)if(A.style.display="block",F)se(F);else{document.querySelectorAll(".category-option").forEach(K=>K.classList.remove("active"));const W=document.getElementById("siteCategory");W&&(W.value="")}};V();const ge=document.querySelector(".cursor-dot"),ye=document.querySelector(".cursor-outline");ge&&ye&&(window.addEventListener("mousemove",A=>{const L=A.clientX,W=A.clientY;ge.style.left=`${L}px`,ge.style.top=`${W}px`,ye.animate({left:`${L}px`,top:`${W}px`},{duration:500,fill:"forwards"})}),document.querySelectorAll("a, button, .logo, .nav-links li, .stat-item, .bento-item, .gallery-item, .social-links a").forEach(A=>{A.addEventListener("mouseenter",()=>{ge.classList.add("active"),ye.classList.add("active")}),A.addEventListener("mouseleave",()=>{ge.classList.remove("active"),ye.classList.remove("active")})}));const ve=document.querySelector(".hero-content");ve&&window.addEventListener("mousemove",F=>{const A=(F.clientX-window.innerWidth/2)*.01,L=(F.clientY-window.innerHeight/2)*.01;ve.style.transform=`translate(${A}px, ${L}px)`});const He=()=>{const F=document.querySelectorAll(".stat-item h3");F.length&&F.forEach(A=>{const L=parseInt(A.getAttribute("data-target"));if(isNaN(L))return;let W=0;const X=L/(2e3/16),he=()=>{W+=X,W<L?(A.innerText=Math.ceil(W),requestAnimationFrame(he)):A.innerText=L+(A.innerText.includes("+")?"+":"")};he()})},_t={threshold:.15,rootMargin:"0px 0px -50px 0px"},pt=new IntersectionObserver((F,A)=>{F.forEach(L=>{L.isIntersecting&&(L.target.classList.add("active"),L.target.classList.contains("stats")&&He(),A.unobserve(L.target))})},_t),ee=F=>{(F||document.querySelectorAll(".reveal:not(.active)")).forEach(L=>{!L.classList.contains("reveal-left")&&!L.classList.contains("reveal-right")&&L.classList.add("reveal-up"),pt.observe(L)})};ee(),new MutationObserver(F=>{F.forEach(A=>{A.addedNodes.forEach(L=>{if(L.nodeType===1){L.classList.contains("reveal")&&ee([L]);const W=L.querySelectorAll(".reveal");W.length>0&&ee(W)}})})}).observe(document.body,{childList:!0,subtree:!0}),(()=>{document.querySelectorAll(".service-card").forEach(A=>{A.addEventListener("mousemove",L=>{const W=A.getBoundingClientRect(),K=L.clientX-W.left,X=L.clientY-W.top;A.style.setProperty("--mouse-x",`${K}px`),A.style.setProperty("--mouse-y",`${X}px`)})})})();try{Bp()}catch(F){console.error("Failed to initialize 3D background:",F)}fetch("/api/health").then(F=>F.json()).then(F=>console.log("Server health check:",F)).catch(F=>console.warn("Server health check failed. Backend might be unreachable.",F));const ke=document.getElementById("navbar"),Ce=document.querySelector(".hamburger"),Fe=document.querySelector(".nav-links"),Mt=document.querySelectorAll(".nav-links a");document.getElementById("openAddModal"),window.addEventListener("scroll",()=>{ke&&(window.scrollY>50?ke.classList.add("sticky"):ke.classList.remove("sticky"))}),Ce&&Fe&&(Ce.addEventListener("click",F=>{F.stopPropagation(),Ce.classList.toggle("active"),Fe.classList.toggle("active");const A=Ce.querySelectorAll("span");A.length>=3&&(Fe.classList.contains("active")?(A[0].style.transform="rotate(45deg) translate(5px, 5px)",A[1].style.opacity="0",A[2].style.transform="rotate(-45deg) translate(7px, -7px)"):(A[0].style.transform="none",A[1].style.opacity="1",A[2].style.transform="none"))}),document.addEventListener("click",F=>{if(Fe.classList.contains("active")&&!Fe.contains(F.target)&&!Ce.contains(F.target)){Ce.classList.remove("active"),Fe.classList.remove("active");const A=Ce.querySelectorAll("span");A.length>=3&&(A.forEach(L=>L.style.transform="none"),A[1].style.opacity="1")}})),Mt&&Ce&&Fe&&Mt.forEach(F=>{F.addEventListener("click",()=>{Ce.classList.remove("active"),Fe.classList.remove("active");const A=Ce.querySelectorAll("span");A.length>=3&&(A.forEach(L=>L.style.transform="none"),A[1].style.opacity="1")})}),document.querySelectorAll('a[href^="#"]').forEach(F=>{F.addEventListener("click",function(A){const L=this.getAttribute("href");if(L!=="#"){A.preventDefault();try{const W=document.querySelector(L);W&&W.scrollIntoView({behavior:"smooth"})}catch{console.warn("Invalid selector:",L)}}})});const Ze=document.getElementById("contactForm");if(Ze){const F=new URLSearchParams(window.location.search),A=F.get("service"),L=F.get("interest"),W=F.get("package");if(A){const K=document.getElementById("contactService");K&&(K.value=A)}if(W){const K=document.getElementById("contactService");K&&(K.value=W);const X=document.getElementById("contactMessage");if(X){let he="";W==="starter"&&(he="Starter Online Presence"),W==="generator"&&(he="Customer Generator"),W==="growth"&&(he="Growth System"),X.value=`I am interested in the "${he}" package. I would like to get started as soon as possible.`}}if(L){const K=document.getElementById("contactMessage"),X=document.getElementById("contactService");K&&(K.value=`I am interested in the "${L}" website from your marketplace. I would like to discuss the details and acquisition process.`),X&&(X.value="web-design")}Ze.addEventListener("submit",async K=>{K.preventDefault();const X=Ze.querySelector('button[type="submit"]'),he=X?X.innerText:"Submit";X&&(X.innerText="Submitting Inquiry...",X.disabled=!0);const De=new FormData(Ze),nt={name:De.get("name"),email:De.get("email"),phone:De.get("phone"),service:De.get("service"),message:De.get("message"),status:"New",createdAt:ni()};try{const Ge=await fetch("/api/consultation",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(nt)}),ue=Ge.headers.get("content-type"),Re=await Ge.text();console.log(">>> [DEBUG] Server status:",Ge.status),console.log(">>> [DEBUG] Server content-type:",ue),console.log(">>> [DEBUG] Server response body:",Re);let We;if(ue&&ue.indexOf("application/json")!==-1)try{We=JSON.parse(Re)}catch{throw new Error("Server returned invalid JSON: "+Re.substring(0,50))}else throw new Error("Server returned non-JSON response type: "+ue+". Content: "+Re.substring(0,50));if(!Ge.ok)throw new Error((We==null?void 0:We.error)||"Failed to submit inquiry");Ze.innerHTML=`
                ...
                `,window.lucide&&window.lucide.createIcons()}catch(Ge){console.error("Error sending inquiry:",Ge),X&&(X.innerText=he,X.disabled=!1),at("Failed to submit inquiry: "+Ge.message,"error")}})}let $e=null,Je=null;const qe=F=>{const A=document.getElementById("viewInquiriesBtn");if(!A)return;let L=A.querySelector(".inquiry-badge");F>0?(L||(L=document.createElement("span"),L.className="inquiry-badge",L.style.background="#ff4444",L.style.color="white",L.style.fontSize="0.6rem",L.style.padding="2px 6px",L.style.borderRadius="10px",L.style.marginLeft="8px",L.style.fontWeight="bold",A.appendChild(L)),L.innerText=F):L&&L.remove()},vt=()=>{if(!P||!fn.currentUser){Je&&(Je(),Je=null);return}const F=$t(Dt(xt,"inquiries"),On("createdAt","desc"));let A=!0;Je=Bn(F,L=>{const W=L.docs.filter(K=>K.data().status==="New"||!K.data().status).length;if(qe(W),!A&&!L.empty){const X=L.docs[0].data(),he=X.createdAt?X.createdAt.toMillis():Date.now();Date.now()-he<1e4&&at(`New Inquiry from ${X.name}!`,"success")}A=!1},L=>{console.error("Global Inquiries Listener Error:",L),L.code==="permission-denied"&&console.warn("Permission denied for global inquiries listener. Dashboard UI may be limited.")})},C=()=>{if(!d)return;if(!fn.currentUser){console.warn("Attempted to load inquiries while unauthenticated."),d.innerHTML=`
            ...
            `,window.lucide&&window.lucide.createIcons();return}$e&&($e(),$e=null),d.innerHTML=`
            <div class="loading-spinner" style="text-align: center; padding: 40px;">
                <div class="spinner"></div>
                <p style="margin-top: 15px; opacity: 0.6;">Retrieving inquiries...</p>
            </div>
        `;const F=$t(Dt(xt,"inquiries"),On("createdAt","desc"));$e=Bn(F,A=>{if(console.log(`>>> [Admin] Inquiries snapshot received. Size: ${A.size}`),A.empty){d.innerHTML=`
            ...
            `,d.appendChild(K);const X=K.querySelector("tbody");A.forEach(Ge=>{const ue=Ge.data(),Re=Ge.id,We=ue.status||"New";let mt="Just now";ue.createdAt&&(ue.createdAt.seconds?mt=new Date(ue.createdAt.seconds*1e3).toLocaleString():ue.createdAt instanceof Date?mt=ue.createdAt.toLocaleString():typeof ue.createdAt=="string"&&(mt=new Date(ue.createdAt).toLocaleString()));const Ct=document.createElement("tr");Ct.style.borderBottom="1px solid rgba(255,255,255,0.1)";const Wt=Re.substring(0,6)+"...",ci=ue.message&&ue.message.length>30?ue.message.substring(0,30)+"...":ue.message;Ct.innerHTML=`
                    <td style="padding: 12px;" title="${Re}">${Wt}</td>
                    <td style="padding: 12px;">${ue.name||"-"}</td>
                    <td style="padding: 12px;"><a href="mailto:${ue.email||""}" style="color: var(--primary-color);">${ue.email||"-"}</a></td>
                    <td style="padding: 12px;">${ue.phone||"-"}</td>
                    <td style="padding: 12px;">${ue.service||"-"}</td>
                    <td style="padding: 12px;" title="${ue.message||""}">${ci||"-"}</td>
                    <td style="padding: 12px;">${mt}</td>
                    <td style="padding: 12px;">
                        <select class="status-select" data-id="${Re}" style="background: rgba(0,0,0,0.5); color: white; border: 1px solid var(--glass-border); padding: 5px; border-radius: 4px;">
                            <option value="New" ${We==="New"?"selected":""}>New</option>
                            <option value="Read" ${We==="Read"?"selected":""}>Read</option>
                            <option value="Replied" ${We==="Replied"?"selected":""}>Replied</option>
                            <option value="Closed" ${We==="Closed"?"selected":""}>Closed</option>
                        </select>
                    </td>
                    <td style="padding: 12px; display: flex; gap: 5px;">
                        <button class="btn btn-secondary btn-sm view-inquiry-btn" data-id="${Re}" style="font-size: 0.7rem; padding: 4px 8px;">View</button>
                        <button class="inquiry-delete-btn" data-id="${Re}" style="background: none; border: none; color: #ff4444; cursor: pointer; font-size: 0.7rem; display: flex; align-items: center; gap: 5px;">
                            <i data-lucide="trash-2" style="width: 12px; height: 12px;"></i>
                        </button>
                    </td>
                `,X.appendChild(Ct)}),X.querySelectorAll(".status-select").forEach(Ge=>{Ge.addEventListener("change",async ue=>{const Re=ue.target.getAttribute("data-id"),We=ue.target.value;try{await qr(kn(xt,"inquiries",Re),{status:We}),at("Status updated to "+We,"success")}catch(mt){console.error("Error updating status:",mt),at("Failed to update status","error")}})}),X.querySelectorAll(".view-inquiry-btn").forEach(Ge=>{Ge.addEventListener("click",ue=>{var mt;const Re=ue.currentTarget.getAttribute("data-id"),We=(mt=A.docs.find(Ct=>Ct.id===Re))==null?void 0:mt.data();We&&Fp(Re,We)})}),X.querySelectorAll(".inquiry-delete-btn").forEach(Ge=>{Ge.addEventListener("click",ue=>{const Re=ue.currentTarget.getAttribute("data-id");Cr("Are you sure you want to delete this inquiry?",async()=>{try{await Bi(kn(xt,"inquiries",Re)),at("Inquiry deleted.","success")}catch(We){console.error("Error deleting inquiry:",We),at("Failed to delete inquiry.","error")}})})}),window.lucide&&window.lucide.createIcons()},A=>{Be(A,ce.LIST,"inquiries")})};f&&(f.onclick=()=>{c.style.display="none",$e&&($e(),$e=null)}),p&&(p.onclick=()=>{l.style.display="none"}),o&&(o.onclick=F=>{F.preventDefault(),document.getElementById("blogModalTitle").innerHTML="Add <span>Blog Post</span>",m.reset(),document.getElementById("editPostId").value="",l.style.display="block"}),document.querySelectorAll(".newsletter form").forEach(F=>{F.addEventListener("submit",async A=>{A.preventDefault();const L=F.querySelector('input[type="email"]'),W=F.querySelector("button"),K=L?L.value:"";if(K){W&&(W.disabled=!0,W.innerText="Joining...");try{await Xi(Dt(xt,"inquiries"),{name:"Newsletter Subscriber",email:K,service:"Newsletter",message:"User subscribed to the elite newsletter.",createdAt:ni(),source:"newsletter",status:"New"}),F.innerHTML=`
                ...
                `,window.lucide&&window.lucide.createIcons()}catch(X){console.error("Newsletter error:",X),W&&(W.disabled=!1,W.innerText="Subscribe"),at("Digital pathways congested. Please try again.","error")}}})});const et=document.querySelector(".scroll-progress");et&&window.addEventListener("scroll",()=>{const F=document.body.scrollTop||document.documentElement.scrollTop,A=document.documentElement.scrollHeight-document.documentElement.clientHeight,L=F/A*100;et.style.width=L+"%"});const tt=document.createElement("button");tt.innerHTML="↑",tt.className="scroll-top-btn",document.body.appendChild(tt),window.addEventListener("scroll",()=>{window.scrollY>500?tt.classList.add("visible"):tt.classList.remove("visible")}),tt.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const Ae=document.querySelector(".hero-bg-video");Ae&&window.addEventListener("scroll",()=>{const F=window.pageYOffset;Ae.style.transform=`translateY(${F*.5}px)`});const M=document.getElementById("scrollDown");M&&M.addEventListener("click",()=>{const F=document.querySelector(".stats");F&&F.scrollIntoView({behavior:"smooth"})});const g=document.querySelector(".cta-bg-glow");g&&window.addEventListener("scroll",()=>{const F=window.pageYOffset,A=document.querySelector(".cta-section").offsetTop;F>A-window.innerHeight&&(g.style.transform=`translate(-50%, -50%) translateY(${(F-A)*.2}px)`)});let P=!1,J=null,te=null;const j=async()=>{try{await yl(),P=!1,Se()}catch(F){console.error("Error logging out",F)}},Se=(F=null)=>{console.log("Updating Admin UI. isAdmin:",P,"User:",F);const A=document.getElementById("adminManageBtn"),L=document.getElementById("viewInquiriesBtn"),W=document.getElementById("adminManageDesc"),K=document.getElementById("admin-dashboard"),X=document.getElementById("adminNavLi"),he=document.getElementById("manageBlogBtn"),De=document.getElementById("manageClientsBtn");if(X&&(X.style.display=P?"block":"none"),he&&(he.style.display=P?"inline-flex":"none"),De&&(De.style.display=P?"inline-flex":"none"),P){if(document.body.classList.add("is-admin"),K){K.style.display="block";let ue=K.querySelector(".admin-user-indicator");ue||(ue=document.createElement("div"),ue.className="admin-user-indicator",ue.style.fontSize="0.7rem",ue.style.opacity="0.5",ue.style.marginTop="10px",K.querySelector(".container").appendChild(ue));const Re=fn.currentUser,We=Re&&Re.emailVerified;ue.innerHTML=`Logged in as: ${F||"Administrator"} ${We?'<span style="color: #00ff00;">(Verified)</span>':'<span style="color: #d4af37;">(Unverified / Development Mode)</span>'}`}}else document.body.classList.remove("is-admin"),K&&(K.style.display="none");A&&(P?(A.innerHTML='<i data-lucide="plus-circle" style="width: 16px; height: 16px; margin-right: 8px;"></i> Add New Website',A.style.display="inline-flex",A.onclick=ue=>{ue.preventDefault(),ne()},L&&(L.style.display="inline-flex",L.onclick=ue=>{ue.preventDefault(),c&&(c.style.display="block",C())}),W&&(W.innerText="Welcome back, Administrator. Your session is active across all pages."),window.lucide&&window.lucide.createIcons()):(A.style.display="none",L&&(L.style.display="none"),W&&(W.innerText="Exclusive access for QuickSite administrators.")));const nt=document.getElementById("clearMarketplaceBtn");nt&&(nt.style.display=P?"inline-flex":"none",nt.onclick=ue=>{ue.preventDefault(),console.log("Clear Marketplace button clicked"),Cr("Are you sure you want to clear ALL dynamic marketplace listings? This cannot be undone.",async()=>{try{const Re=$t(Dt(xt,"marketplaceItems")),mt=(await ir(Re)).docs.map(Ct=>Bi(Ct.ref));await Promise.all(mt),at("Marketplace cleared successfully.")}catch(Re){Be(Re,ce.DELETE,"marketplaceItems")}})});const Ge=document.getElementById("adminLogoutBtn");Ge&&(Ge.style.display=P?"inline-flex":"none"),e&&(P?(e.innerText="Admin Logout",e.style.display="inline-block",e.style.opacity="1",e.onclick=async ue=>{ue.preventDefault(),await j()}):e.style.display="none")};let le=0;const Le=document.getElementById("copyrightText");Le&&(Le.style.cursor="default",Le.addEventListener("click",()=>{if(le++,le===5){const F=document.getElementById("adminModal");F&&(F.style.display="block"),le=0,at("Administrator Gateway Opened","success")}setTimeout(()=>{le=0},3e3)}));let Oe=null;_l(fn,F=>{if(!(F&&F.uid===Oe)){if(Oe=F?F.uid:null,console.log("Auth state changed:",F?`logged in (${F.email})`:"logged out"),F){const A=F.email?F.email.toLowerCase().trim():"";if(console.log("Checking admin privileges for:",A),["michaelmulili41@gmail.com","michael.mulili@quicksite.com","michael.michael@quicksite.com","quicksitekenya@gmail.com"].includes(A)){F.emailVerified||console.info("Admin access: Operating in unverified developer mode.",A),console.log("Admin access locally recognized for:",A),P=!0,document.body.classList.add("is-admin");const W=document.getElementById("adminModal");if(W&&(W.style.display="none"),new URLSearchParams(window.location.search).get("action")==="addWebsite"){const X=document.getElementById("addWebsiteModal");X&&(X.style.display="block"),window.history.replaceState({},document.title,window.location.pathname)}Se(A),vt()}else{console.warn("Access denied for non-admin user:",A),P=!1,document.body.classList.remove("is-admin"),Je&&(Je(),Je=null);const W=document.getElementById("adminModal");W&&W.style.display==="block"&&(at("Access Denied: Your account ("+A+") does not have administrator privileges.","error"),j()),Se()}}else P=!1,document.body.classList.remove("is-admin"),$e&&($e(),$e=null),Je&&(Je(),Je=null),Se();u&&D(),y&&Me(),T&&Te(),document.getElementById("liveSlider")&&we()}}),Se(),i&&t&&(t.onclick=()=>i.style.display="none"),n&&n.addEventListener("submit",async F=>{F.preventDefault();const A=r.value,L=s.value;if(!A||!L){at("Please enter both email and password.","error");return}const W=document.getElementById("loadingOverlay");W&&(W.style.display="flex");try{await xl(A,L),W&&(W.style.display="none"),i&&(i.style.display="none")}catch(K){if(P){console.log("Manual login failed but user is authenticated. Ignoring error."),W&&(W.style.display="none"),i&&(i.style.display="none");return}if(K.code==="auth/invalid-credential"){console.log("Invalid credential, attempting auto-signup...");try{await vl(A,L),at("Account created and signed in successfully!","success"),W&&(W.style.display="none"),i&&(i.style.display="none");return}catch(X){console.error("Auto-signup failed:",X),W&&(W.style.display="none"),at("Sign In failed: Invalid email or password.","error");return}}if(W&&(W.style.display="none"),console.error("Sign In error:",K),K.code==="auth/network-request-failed"){at("SECURITY BLOCKED: Your Ad-blocker or Brave Shields is preventing login. See the instructions below.","error"),console.warn("AD-BLOCKER DETECTED: Firebase Auth requests are being blocked. This is common with uBlock Origin or Brave Shields.");const X=document.getElementById("authNetworkNote");X&&(X.style.display="block",X.scrollIntoView({behavior:"smooth",block:"nearest"})),alert(`⚠️ FIREBASE BLOCKED BY BROWSER ⚠️

You are inside an iframe and your browser's privacy shields are blocking the login.

We will now explicitly break out of the iframe and auto-open the application in a new tab for you to log in securely. Please hit Sign In on the new tab.`),window.open(window.location.href,"_blank")}else at("Sign In failed: "+K.message,"error")}}),a&&(a.onclick=async F=>{F.preventDefault(),console.log("Admin Logout button clicked"),await j()});const ie=document.getElementById("testConnectionBtn");ie&&(ie.onclick=async()=>{if(P){at("Initiating test flow...","info");try{const L=await(await fetch("/api/consultation",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:"Admin Test",email:"quicksitekenya@gmail.com",service:"System Test",message:"This is a test inquiry to verify the notification and dashboard flow."})})).json();L.success?(at("Test flow successful! Check your email and dashboard.","success"),C()):at("Test flow failed: "+L.error,"error")}catch(F){at("Test flow error: "+F.message,"error")}}}),_&&S&&(S.onclick=()=>_.style.display="none",window.addEventListener("click",F=>{F.target===_&&(_.style.display="none")})),h&&h.addEventListener("submit",async F=>{if(F.preventDefault(),!P){at("Unauthorized: Only administrators can list websites.","error");return}const A=document.getElementById("siteName").value,L=document.getElementById("siteCategory").value,W=document.getElementById("sitePrice").value,K=document.getElementById("siteDesc").value,X=document.getElementById("siteLink").value,he=document.getElementById("siteImage").value,De=h.querySelector('button[type="submit"]'),nt=De.innerText;De.innerText="Publishing...",De.disabled=!0;try{await Xi(Dt(xt,"marketplaceItems"),{name:A,category:L,price:W,desc:K,img:he,link:X,createdAt:ni()}),h.reset(),document.querySelectorAll(".category-option").forEach(Re=>Re.classList.remove("active"));const ue=document.getElementById("siteCategory");ue&&(ue.value=""),_&&(_.style.display="none"),at("Website submitted successfully!")}catch(Ge){Be(Ge,ce.WRITE,"marketplaceItems")}finally{De.innerText=nt,De.disabled=!1}});let oe;const be=()=>{const F=document.getElementById("liveSlider"),A=document.getElementById("prevSlide"),L=document.getElementById("nextSlide");if(F&&A&&L){oe&&clearInterval(oe);let W=0;const X=F.querySelectorAll(".slide").length;if(X>0){const he=()=>{F.style.transform=`translateX(-${W*100}%)`};L.onclick=()=>{W=(W+1)%X,he()},A.onclick=()=>{W=(W-1+X)%X,he()},oe=setInterval(()=>{W=(W+1)%X,he()},5e3)}}},we=()=>{const F=document.getElementById("liveSlider");if(!F)return;te&&(te(),te=null);const A=$t(Dt(xt,"marketplaceItems"),On("createdAt","desc"));te=Bn(A,L=>{F.querySelectorAll(".dynamic-slide").forEach(X=>X.remove());const K=F.querySelector(".no-items-message");K&&!L.empty?K.style.display="none":K&&L.empty&&(K.style.display="block"),L.forEach(X=>{const he=X.data();if(!he)return;const De=he.name||"Unnamed Project",nt=he.desc||"Premium digital asset.",Ge=Ai(he.img,De,1200,600),ue=document.createElement("div");ue.className="slide dynamic-slide",ue.innerHTML=`
                    <div class="slide-content">
                        <img src="${Ge}" alt="${De}" onerror="this.src='https://placehold.co/800x500/1a1a1a/d4af37?text=Preview'" referrerPolicy="no-referrer">
                        <div class="slide-info">
                            <span class="slide-tag">Marketplace</span>
                            <h3>${De}</h3>
                            <p>${nt}</p>
                            <a href="portfolio.html?site=${encodeURIComponent(De)}" class="btn btn-primary btn-sm">Visit Site</a>
                        </div>
                    </div>
                `,F.insertBefore(ue,F.firstChild)}),be()})};be();const ce={CREATE:"create",UPDATE:"update",DELETE:"delete",LIST:"list",GET:"get",WRITE:"write"},Be=(F,A,L)=>{var K,X,he,De,nt,Ge;const W={error:F instanceof Error?F.message:String(F),authInfo:{userId:(K=fn.currentUser)==null?void 0:K.uid,email:(X=fn.currentUser)==null?void 0:X.email,emailVerified:(he=fn.currentUser)==null?void 0:he.emailVerified,isAnonymous:(De=fn.currentUser)==null?void 0:De.isAnonymous,tenantId:(nt=fn.currentUser)==null?void 0:nt.tenantId,providerInfo:((Ge=fn.currentUser)==null?void 0:Ge.providerData.map(ue=>({providerId:ue.providerId,displayName:ue.displayName,email:ue.email,photoUrl:ue.photoURL})))||[]},operationType:A,path:L};if(console.error("Firestore Error: ",JSON.stringify(W)),W.error.includes("Could not reach Cloud Firestore backend")||W.error.includes("the client is offline")){const ue=document.createElement("div");ue.className="container firestore-error-msg",ue.style.color="#ff4444",ue.style.padding="20px",ue.style.textAlign="center",ue.innerHTML=`
            ...
            `,u&&(document.querySelectorAll(".firestore-error-msg").forEach(We=>We.remove()),u.parentElement.insertBefore(ue,u))}throw new Error(JSON.stringify(W))},D=()=>{if(!u)return;J&&(J(),J=null);const F=$t(Dt(xt,"marketplaceItems"),On("createdAt","desc"));J=Bn(F,A=>{if(u.innerHTML="",A.empty){u.innerHTML=`
        ...
        `;const K=W.querySelector(".marketplace-grid");A.forEach(X=>{const he=X.name||"Unnamed Project",De=X.price||"0",nt=X.desc||"No description available.",Ge=X.category||"Elite Website",ue=X.link||"#",Re=Ai(X.img,he),We=document.createElement("div");We.className="marketplace-item dynamic-item";const mt=isNaN(Number(De))?De:Number(De).toLocaleString(),Ct=P?`
            ...
            `:"";if(We.innerHTML=`
                ...
                ${Ct}
                <img src="${Re}" alt="${he}" onerror="this.src='https://placehold.co/800x500/1a1a1a/d4af37?text=Preview'" referrerPolicy="no-referrer">
                <div class="item-content">
                    <div class="item-header">
                        <div>
                            <h3 style="margin-bottom: 5px;">${he}</h3>
                            <span style="font-size: 0.7rem; color: var(--primary-color); text-transform: uppercase; letter-spacing: 1px;">${Ge}</span>
                        </div>
                        <span class="price-tag">KSh ${mt}</span>
                    </div>
                    <p>${nt}</p>
                    <div class="item-footer">
                        <a href="contact.html?interest=${encodeURIComponent(he)}" class="btn btn-secondary btn-sm">Inquire Now</a>
                        <a href="${ue}" class="btn btn-primary btn-sm" target="_blank">Live Demo</a>
                    </div>
                </div>
            `,P){const Wt=We.querySelector(".delete-item-btn");Wt&&(Wt.onclick=ci=>{ci.preventDefault(),ci.stopPropagation();const nr=Wt.getAttribute("data-id");Cr(`Are you sure you want to delete "${he}"?`,async()=>{try{await Bi(kn(xt,"marketplaceItems",nr)),at("Item deleted successfully.")}catch(Xr){Be(Xr,ce.DELETE,"marketplaceItems/"+nr)}})})}K.appendChild(We)}),L.appendChild(W)};let ae=null;const Me=()=>{if(!y)return;ae&&(ae(),ae=null);const F=$t(Dt(xt,"marketplaceItems"),On("createdAt","desc"));ae=Bn(F,A=>{if(y.innerHTML="",A.empty){y.innerHTML=`
                    <div class="no-items-message" style="text-align: center; padding: 40px; opacity: 0.6;">
        ...
        `;const K=W.querySelector(".portfolio-grid");A.forEach(X=>{const he=X.name||"Unnamed Project",De=X.category||"Elite Website",nt=X.link||"#",Ge=Ai(X.img,he),ue=document.createElement("div");ue.className="portfolio-item dynamic-item",ue.innerHTML=`
                <img src="${Ge}" alt="${he}" referrerPolicy="no-referrer">
                <div class="portfolio-overlay">
                    <h3>${he}</h3>
                    <p>${De}</p>
                    <a href="${nt}" class="btn btn-primary btn-sm" target="_blank">View Live Site</a>
                </div>
            `,K.appendChild(ue)}),L.appendChild(W)};let Z=null;const Te=()=>{if(!T)return;Z&&(Z(),Z=null);const F=$t(Dt(xt,"marketplaceItems"),On("createdAt","desc"),Ba(3));Z=Bn(F,A=>{T.querySelectorAll(".dynamic-item").forEach(K=>K.remove());const W=T.querySelector(".static-fallback");W&&!A.empty?W.style.display="none":W&&A.empty&&(W.style.display="block"),A.forEach((K,X)=>{const he=K.data();if(!he)return;const De=he.name||"Unnamed Project",nt=he.category||"Elite Website",Ge=he.desc||"No description available.",ue=he.link||"#",Re=Ai(he.img,De,1200,800),We=X%2!==0,mt=document.createElement("div");mt.className=`featured-grid dynamic-item reveal ${We?"reverse reveal-right":"reveal-left"}`,mt.style.marginBottom="60px",mt.innerHTML=`
                    <div class="featured-img">
                        <img src="${Re}" alt="${De}" referrerPolicy="no-referrer">
                    </div>
                    <div class="featured-info">
                        <span class="section-tag" style="margin-bottom: 15px;">${nt}</span>
                        <h2>${De.split(" ")[0]} <span>${De.split(" ").slice(1).join(" ")}</span></h2>
                        ...
                        <a href="${ue}" class="btn btn-primary" target="_blank">Explore Project</a>
                    </div>
                `,T.appendChild(mt)}),window.lucide&&window.lucide.createIcons(),typeof ee=="function"&&ee()},A=>{Be(A,ce.LIST,"marketplaceItems")})};(async()=>{const A=new URLSearchParams(window.location.search).get("site");if(A&&window.location.pathname.includes("portfolio.html")){const L=document.querySelector(".page-header h1"),W=document.querySelector(".page-header p");if(L&&(L.innerHTML=`<span>${A}</span>`),W){W.innerText=`Detailed overview of the ${A} digital masterpiece. Crafted with precision for Nairobi's elite.`;const X=document.createElement("a");X.href="portfolio.html",X.className="btn btn-primary btn-sm",X.style.marginTop="20px",X.innerText="← Back to All Projects",W.parentNode.appendChild(X)}try{const X=$t(Dt(xt,"marketplaceItems"),Yr("name","==",A),Ba(1));await ir(X)}catch(X){console.error("Error fetching site details:",X)}window.scrollTo(0,0),document.querySelectorAll(".portfolio-item, .marketplace-item").forEach(X=>{var De;const he=(De=X.querySelector("h3"))==null?void 0:De.innerText;he&&A.toLowerCase().includes(he.toLowerCase())&&(X.scrollIntoView({behavior:"smooth",block:"center"}),X.style.border="2px solid var(--primary-color)",X.style.boxShadow="0 0 30px rgba(212, 175, 55, 0.3)")})}})();const ut=()=>{const F=document.getElementById("blog-grid");if(!F)return;const A=$t(Dt(xt,"blogPosts"),On("createdAt","desc"));Bn(A,L=>{if(F.innerHTML="",L.empty){F.innerHTML='<p style="grid-column: 1/-1; text-align: center; opacity: 0.5;">No elite insights published yet. Check back soon.</p>';return}L.forEach(W=>{const K=W.data(),X=W.id,he=document.createElement("article");he.className="blog-card reveal";const De=Ai(K.img,K.title,600,400);he.innerHTML=`
                    <div class="blog-img">
                        <img src="${De}" alt="${K.title}" referrerPolicy="no-referrer">
        ...
        `,document.body.appendChild(X),window.lucide&&window.lucide.createIcons(),X.querySelector("#tiktok-share-btn").onclick=()=>{navigator.clipboard.writeText(K).then(()=>{at("Link copied! Open TikTok to paste and share."),setTimeout(()=>{window.open("https://www.tiktok.com/","_blank")},1500)})},X.querySelector("#instagram-share-btn").onclick=()=>{navigator.clipboard.writeText(K).then(()=>{at("Link copied! Open Instagram to paste in your bio/story."),setTimeout(()=>{window.open("https://www.instagram.com/","_blank")},1500)})};const he=()=>document.body.removeChild(X);X.querySelector("#close-share-prompt").onclick=he,X.onclick=De=>{De.target===X&&he()}};m&&(m.onsubmit=async F=>{F.preventDefault();const A=document.getElementById("editPostId").value,L=document.getElementById("postImgInput").value,W=m.querySelector('button[type="submit"]'),K=W.innerText;W.innerText="Publishing...",W.disabled=!0;try{const X={title:document.getElementById("postTitleInput").value,subtitle:document.getElementById("postSubtitleInput").value,img:L,category:document.getElementById("postCategoryInput").value,content:document.getElementById("postContentInput").value,date:new Date().toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"}),createdAt:ni()};let he=A;A?(await qr(kn(xt,"blogPosts",A),X),at("Insight updated successfully.")):(he=(await Xi(Dt(xt,"blogPosts"),X)).id,at("New elite insight published.")),l.style.display="none",m.reset()}catch(X){Be(X,A?ce.UPDATE:ce.CREATE,"blogPosts")}finally{W.innerText=K,W.disabled=!1}});const tr=async()=>{const A=new URLSearchParams(window.location.search).get("id");if(A&&window.location.pathname.includes("blog-post.html"))try{const L=$t(Dt(xt,"blogPosts"),Yr("__name__","==",A)),W=await ir(L);if(W.empty){const K=document.getElementById("post-title"),X=document.getElementById("post-subtitle");K&&(K.innerText="Article Not Found"),X&&(X.innerText="The requested article could not be located.")}else{const K=W.docs[0].data();document.title=`${K.title} | QuickSite Kenya`;const X=document.getElementById("post-date"),he=document.getElementById("post-title"),De=document.getElementById("post-subtitle"),nt=document.getElementById("post-img-container"),Ge=document.getElementById("post-body");if(X&&(X.innerText=K.date),he&&(he.innerText=K.title),De&&(De.innerText=K.subtitle),nt){const ue=Ai(K.img,K.title,1200,600);nt.innerHTML=`<img src="${ue}" alt="${K.title}" referrerPolicy="no-referrer">`}Ge&&(Ge.innerHTML=K.content),window.lucide&&window.lucide.createIcons()}}catch(L){Be(L,ce.GET,`blogPosts/${A}`)}};ut(),tr()});
